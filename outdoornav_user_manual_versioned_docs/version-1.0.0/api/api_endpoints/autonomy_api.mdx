...
&emsp;&emsp;**Message Type:** clearpath_dock_msgs/DockActionFeedback

&emsp;&emsp;**Description:** Feedback topic from the dock action.

#### /dock/result

&emsp;&emsp;**Message Type:** clearpath_dock_msgs/DockActionResult
...
&emsp;&emsp;**Message Type:** clearpath_dock_msgs/UndockActionFeedback

&emsp;&emsp;**Description:** Feedback topic from the undock action.

#### /undock/result

&emsp;&emsp;**Message Type:** clearpath_dock_msgs/UndockActionResult
...
&emsp;&emsp;**Message Type:** clearpath_dock_msgs/msg/DockActionGoal
...
&emsp;&emsp;**Message Type:** clearpath_dock_msgs/msg/UndockActionGoal
...
&emsp;&emsp;**Service Type:** std_srvs/srv/Trigger
...
&emsp;&emsp;**Service Type:** clearpath_navigation_msgs/srv/SetPathShifter
...
&emsp;&emsp;**Action Type:** clearpath_dock_msgs/action/Dock
