...
The API documentation has been divided into two sections, whose details are provided below:

-   [Endpoints](./api_endpoints/autonomy/mission): Provides the endpoints for all autonomy, docking,
    localization, logger, and mission manager endpoints that can be used to control/monitor the
    OutdoorNav system.
-   [Examples](./api_examples/looped_mission): API examples will be available as of version 2.3.0.
