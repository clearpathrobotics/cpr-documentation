...
&emsp;&emsp;**Message Type:** [cpr_control_msgs/ControlSelectionState](definitions.mdx#msg-control-selection-state)
...
&emsp;&emsp;**Message Type:** [cpr_control_msgs/ControlMode](definitions.mdx#msg-control-mode)

&emsp;&emsp;**Description:** Current control mode (NEUTRAL, MANUAL, AUTONOMY).

#### /dock/feedback

&emsp;&emsp;**Message Type:** [cpr_dock_msgs/DockActionFeedback](definitions.mdx#action-dock)

&emsp;&emsp;**Description:** Feedback topic from the dock action.

#### /dock/result

&emsp;&emsp;**Message Type:** [cpr_dock_msgs/DockActionResult](definitions.mdx#action-dock)

&emsp;&emsp;**Description:** Result topic from the dock action.

#### /dock/properties

&emsp;&emsp;**Message Type:** [cpr_dock_msgs/DockProperties](definitions.mdx#msg-dock-properties)
...
&emsp;&emsp;**Message Type:** [cpr_dock_msgs/DockState](definitions.mdx#msg-dock-state)
...
&emsp;&emsp;**Message Type:** [cpr_localization_msgs/LocalizationStatus](definitions.mdx#msg-localization-status)
...
&emsp;&emsp;**Message Type:** cpr_navigation_msgs/MissionActionFeedback

&emsp;&emsp;**Description:** Feedback topic from the mission action.

#### /mission/result

&emsp;&emsp;**Message Type:** cpr_navigation_msgs/MissionActionResult

&emsp;&emsp;**Description:** Result topic from the mission action.

#### /navigation/current_goal_info

&emsp;&emsp;**Message Type:** [cpr_navigation_msgs/CurrentGoalInfo](definitions.mdx#msg-current-goal-info)

&emsp;&emsp;**Description:** string identifier (id), goal and viapoint positions,
headings, pose/yaw tolerances, etc\...

#### /navigation/distance_to_goal

&emsp;&emsp;**Message Type:** [cpr_navigation_msgs/DistanceToGoal](definitions.mdx#msg-distance-to-goal)
...
&emsp;&emsp;**Message Type:** [cpr_navigation_msgs/MotionState](definitions.mdx#msg-motion-state)
...
&emsp;&emsp;**Message Type:** [cpr_navigation_msgs/OdomIntent](definitions.mdx#msg-odom-intent)
...
&emsp;&emsp;**Message Type:** [cpr_navigation_msgs/Progress](definitions.mdx#msg-navigation-progress)
...
&emsp;&emsp;**Message Type:** [cpr_navigation_msgs/ScanPoints](definitions.mdx#msg-scan-points)
...
&emsp;&emsp;**Message Type:** [cpr_navigation_msgs/NavigationState](definitions.mdx#msg-navigation-state)
...
&emsp;&emsp;**Message Type:** [cpr_navigation_msgs/TrackError](definitions.mdx#msg-track-error)
...
&emsp;&emsp;**Message Type:** [cpr_safety_msgs/WatchdogStatus](definitions.mdx#msg-safety-watchdog)
...
&emsp;&emsp;**Message Type:** [cpr_dock_msgs/TargetTrackerState](definitions.mdx#msg-target-tracker-state)

&emsp;&emsp;**Description:** The state information for target tracker used as part of docking.

#### /undock/feedback

&emsp;&emsp;**Message Type:** [cpr_dock_msgs/UndockActionFeedback](definitions.mdx#action-undock)

&emsp;&emsp;**Description:** Feedback topic from the undock action.

#### /undock/result

&emsp;&emsp;**Message Type:** [cpr_dock_msgs/UndockActionResult](definitions.mdx#action-undock)
...
&emsp;&emsp;**Message Type:** cpr_navigation_msgs/msg/MissionActionGoal
...
&emsp;&emsp;**Message Type:** [cpr_dock_msgs/msg/DockActionGoal](definitions.mdx#action-dock)
...
&emsp;&emsp;**Message Type:** [cpr_dock_msgs/msg/UndockActionGoal](definitions.mdx#action-undock)
...
&emsp;&emsp;**Service Type:** [cpr_control_msgs/srv/SetControlMode](definitions.mdx#srv-set-control-mode)
...
&emsp;&emsp;**Service Type:** [cpr_dock_msgs/srv/AddDock](definitions.mdx#srv-add-dock)
...
&emsp;&emsp;**Service Type:** [cpr_dock_msgs/srv/RemoveDock](definitions.mdx#srv-remove-dock)
...
&emsp;&emsp;**Service Type:** [cpr_dock_msgs/srv/SetDockLocationByID](definitions.mdx#srv-set-dock-location-by-id)
...
&emsp;&emsp;**Service Type:** [cpr_dock_msgs/srv/SetDockLocationByName](definitions.mdx#srv-set-dock-location-by-name)
...
&emsp;&emsp;**Service Type:** [cpr_localization_msgs/srv/SetDatum](definitions.mdx#srv-set-datum)
...
&emsp;&emsp;**Service Type:** [cpr_navigation_msgs/srv/SetPathSmoother](definitions.mdx#srv-set-path-smoother)
...
#### /navigation/set_path_shifter

&emsp;&emsp;**Service Type:** [cpr_navigation_msgs/srv/SetPathShifter](definitions.mdx#srv-set-path-shifter)
...
&emsp;&emsp;**Service Type:** [cpr_navigation_msgs/srv/SetStopDistance](definitions.mdx#srv-set-stop-distance)
...
&emsp;&emsp;**Service Type:** [cpr_navigation_msgs/srv/SetDelayCompensation](definitions.mdx#srv-set-delay-compensation)
...
&emsp;&emsp;**Action Type:** [cpr_dock_msgs/action/Dock](definitions.mdx#action-dock)
...
&emsp;&emsp;**Action Type:** [cpr_localization_msgs/action/SurveyBaseStation](definitions.mdx#action-survey-base-station)

&emsp;&emsp;**Description:** Start surveying the base station, if available.

#### /mission

&emsp;&emsp;**Action Type:** [cpr_navigation_msgs/action/Mission](definitions.mdx#action-mission)
...
&emsp;&emsp;**Action Type:** [cpr_dock_msgs/action/Dock](definitions.mdx#action-undock)
