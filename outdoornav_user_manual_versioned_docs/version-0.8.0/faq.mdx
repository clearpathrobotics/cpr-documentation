...
1.  **How do I start, pause or stop a mission?**
    ...
    See [Mission Execution](web_user_interface/ui_autonomous_mode.mdx#mission-execution) for
...
1.  **When trying to dock, my UGV drives towards the dock but stops 2
    ...
    the instructions in [Set Dock Location](getting_started/system_setup.mdx#set-dock-location).
