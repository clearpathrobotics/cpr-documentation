...
on simulation, refer to [Simulation](/docs_outdoornav_user_manual/simulation.mdx).
...
[Connecting to the OutdoorNav Computer](../navigation.mdx#connecting-to-outdoornav-computer) for
