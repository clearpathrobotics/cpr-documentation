...
#### clearpath_mission_scheduler_msgs/msg/NextSchedule.msg {#scheduler-nextschedule}
...
#### clearpath_mission_manager_msgs/srv/CreateNetworkMap.srv {#storage-createnetworkmap}
...
```
#### clearpath_mission_manager_msgs/srv/CreateNetworkMission.srv {#storage-createnetworkmission}
...
```
# Action definition for local docking a Clearpath UGV from one of its charging docks.
...
#### clearpath_dock_msgs/action/LocalUndock.action {#action-local-undock}
