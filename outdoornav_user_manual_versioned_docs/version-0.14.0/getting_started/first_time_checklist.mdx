...
[Mission Creation](../web_user_interface/ui_waypoint_mode.mdx#mission-creation).

### ☐ After creating a new mission, can you execute the mission?

To execute a mission refer to [Mission Execution](../web_user_interface/ui_waypoint_mode.mdx#mission-execution).
