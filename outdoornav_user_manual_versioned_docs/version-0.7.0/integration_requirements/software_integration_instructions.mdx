...
:::note
If you are installing the OutdoorNav software on a secondary or Starter Kit computer, you must also complete the [Platform Computer Checklist](platform_computer_checklist.mdx)
:::
