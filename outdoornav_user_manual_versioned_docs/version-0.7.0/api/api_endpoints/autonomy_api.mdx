...
**Message Type:** [cpr_control_msgs/ControlSelectionState](definitions.mdx#msg-control-selection-state)
...
**Message Type:** [cpr_control_msgs/ControlMode](definitions.mdx#msg-control-mode)
...
**Message Type:** [cpr_localization_msgs/LocalizationStatus](definitions.mdx#msg-localization-status)
...
**Message Type:** [cpr_navigation_msgs/CurrentGoalInfo](definitions.mdx#msg-current-goal-info)
...
**Message Type:** [cpr_navigation_msgs/DistanceToGoal](definitions.mdx#msg-distance-to-goal)
...
**Message Type:** [cpr_navigation_msgs/MotionState](definitions.mdx#msg-motion-state)
...
**Message Type:** [cpr_navigation_msgs/OdomIntent](definitions.mdx#msg-odom-intent)
...
**Message Type:** [cpr_navigation_msgs/Progress](definitions.mdx#msg-navigation-progress)
...
**Message Type:** [cpr_navigation_msgs/ScanPoints](definitions.mdx#msg-scan-points)
...
**Message Type:** [cpr_navigation_msgs/NavigationState](definitions.mdx#msg-navigation-state)
...
**Message Type:** [cpr_navigation_msgs/TrackError](definitions.mdx#msg-track-error)
...
**Message Type:** [cpr_safety_msgs/WatchdogStatus](definitions.mdx#msg-safety-watchdog)
...
**Service Type:** [cpr_control_msgs/srv/SetControlMode](definitions.mdx#srv-set-control-mode)
...
**Service Type:** [cpr_localization_msgs/srv/SetDatum](definitions.mdx#srv-set-datum)
...
**Service Type:** [cpr_navigation_msgs/srv/SetPathSmoother](definitions.mdx#srv-set-path-smoother)
...
**Service Type:** [cpr_navigation_msgs/srv/SetPathShifter](definitions.mdx#srv-set-path-shifter)
...
**Service Type:** [cpr_navigation_msgs/srv/SetStopDistance](definitions.mdx#srv-set-stop-distance)
...
**Service Type:** [cpr_navigation_msgs/srv/SetDelayCompensation](definitions.mdx#srv-set-delay-compensation)
...
**Action Type:** [cpr_localization_msgs/action/SurveyBaseStation](definitions.mdx#action-survey-base-station)

**Description:** Start surveying the base station, if available.

#### mission

**Action Type:** [cpr_navigation_msgs/action/Mission](definitions.mdx#action-mission)
...
**Action Type:** [cpr_dock_msgs/action/Dock](definitions.mdx#action-dock)
