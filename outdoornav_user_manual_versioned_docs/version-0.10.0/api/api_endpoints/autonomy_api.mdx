...
&emsp;&emsp;**Message Type:** [clearpath_control_msgs/ControlSelectionState](definitions#msg-control-selection-state)
...
&emsp;&emsp;**Message Type:** [clearpath_control_msgs/ControlMode](definitions#msg-control-mode)

&emsp;&emsp;**Description:** Current control mode (NEUTRAL, MANUAL, AUTONOMY).

#### /dock/feedback

&emsp;&emsp;**Message Type:** [clearpath_dock_msgs/DockActionFeedback](definitions#action-dock)

&emsp;&emsp;**Description:** Feedback topic from the dock action.

#### /dock/result

&emsp;&emsp;**Message Type:** [clearpath_dock_msgs/DockActionResult](definitions#action-dock)

&emsp;&emsp;**Description:** Result topic from the dock action.

#### /dock/properties

&emsp;&emsp;**Message Type:** [clearpath_dock_msgs/DockProperties](definitions#msg-dock-properties)
...
&emsp;&emsp;**Message Type:** [clearpath_dock_msgs/DockState](definitions#msg-dock-state)
...
&emsp;&emsp;**Message Type:** [clearpath_localization_msgs/LocalizationStatus](definitions#msg-localization-status)
...
&emsp;&emsp;**Message Type:** nav_msgs/msg/Path
...
&emsp;&emsp;**Message Type:** [clearpath_navigation_msgs/Metrics](definitions#msg-metrics)
...
&emsp;&emsp;**Message Type:** [clearpath_navigation_msgs/MotionState](definitions#msg-motion-state)
...
&emsp;&emsp;**Message Type:** [clearpath_navigation_msgs/OdomIntent](definitions#msg-odom-intent)
...
&emsp;&emsp;**Message Type:** [clearpath_navigation_msgs/Progress](definitions#msg-navigation-progress)
...
&emsp;&emsp;**Message Type:** [clearpath_navigation_msgs/ScanPoints](definitions#msg-scan-points)
...
&emsp;&emsp;**Message Type:** [clearpath_navigation_msgs/NavigationState](definitions#msg-navigation-state)
...
&emsp;&emsp;**Message Type:** [clearpath_navigation_msgs/TrackError](definitions#msg-track-error)
...
&emsp;&emsp;**Message Type:** [clearpath_safety_msgs/WatchdogStatus](definitions#msg-safety-watchdog)
...
&emsp;&emsp;**Message Type:** [clearpath_dock_msgs/TargetTrackerState](definitions#msg-target-tracker-state)

&emsp;&emsp;**Description:** The state information for target tracker used as part of docking.

#### /undock/feedback

&emsp;&emsp;**Message Type:** [clearpath_dock_msgs/UndockActionFeedback](definitions#action-undock)

&emsp;&emsp;**Description:** Feedback topic from the undock action.

#### /undock/result

&emsp;&emsp;**Message Type:** [clearpath_dock_msgs/UndockActionResult](definitions#action-undock)
...
&emsp;&emsp;**Message Type:** [clearpath_dock_msgs/msg/DockActionGoal](definitions#action-dock)
...
&emsp;&emsp;**Message Type:** [clearpath_dock_msgs/msg/UndockActionGoal](definitions#action-undock)
...
&emsp;&emsp;**Service Type:** [clearpath_control_msgs/srv/SetControlMode](definitions#srv-set-control-mode)
...
&emsp;&emsp;**Service Type:** [clearpath_dock_msgs/srv/AddDock](definitions#srv-add-dock)
...
&emsp;&emsp;**Service Type:** [clearpath_dock_msgs/srv/ExportData](definitions#srv-export-docks)

&emsp;&emsp;**Description:** Export all dock locations to a JSON string. Useful for backing up docks or copying
dock data to multiple robots using the corresponding `import` service.

:::note

The data returned is a JSON string representing the underlying storage file's contents.

:::

#### /dock/import

&emsp;&emsp;**Service Type:** [clearpath_dock_msgs/srv/ImportData](definitions#srv-import-docks)

&emsp;&emsp;**Description:** Import dock data generated with the corresponding `export` service. Existing dock
data will be deleted and replaced with the imported data.

:::note

All existing docks are deleted permanently and the entire database contents are replaced
with the imported data.

The data itself is a JSON string representing the underlying on-disk storage.

:::

#### /dock/remove

&emsp;&emsp;**Service Type:** [clearpath_dock_msgs/srv/RemoveDock](definitions#srv-remove-dock)
...
&emsp;&emsp;**Service Type:** [clearpath_dock_msgs/srv/SetDockLocationByName](definitions#srv-set-dock-location-by-name)
...
&emsp;&emsp;**Service Type:** [clearpath_localization_msgs/srv/SetDatum](definitions#srv-set-datum)
...
&emsp;&emsp;**Service Type:** [clearpath_navigation_msgs/srv/SetPathSmoother](definitions#srv-set-path-smoother)
...
&emsp;&emsp;**Service Type:** [clearpath_navigation_msgs/srv/SetPathShifter](definitions#srv-set-path-shifter)
...
&emsp;&emsp;**Service Type:** [clearpath_navigation_msgs/srv/SetStopDistance](definitions#srv-set-stop-distance)
...
&emsp;&emsp;**Service Type:** [clearpath_navigation_msgs/srv/SetDelayCompensation](definitions#srv-set-delay-compensation)
...
&emsp;&emsp;**Action Type:** [clearpath_dock_msgs/action/Dock](definitions#action-dock)
...
&emsp;&emsp;**Action Type:** [clearpath_localization_msgs/action/SurveyBaseStation](definitions#action-survey-base-station)

&emsp;&emsp;**Description:** Start surveying the base station, if available.

#### /mission

&emsp;&emsp;**Action Type:** [clearpath_navigation_msgs/action/Mission](definitions#action-mission)
...
&emsp;&emsp;**Action Type:** [clearpath_dock_msgs/action/Dock](definitions#action-undock)
