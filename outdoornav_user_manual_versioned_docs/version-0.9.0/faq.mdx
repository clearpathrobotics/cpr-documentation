...
7.  **Can I use OutdoorNav without using the UI?**
    ...
    set the datum, assign [custom tasks](./features/custom_tasks) to your mission. If using Python, we provide a set of libraries that
    speed up the develpment process. See some of the [example codes](./api/api_examples) for an idea of how to generate these scripts.
