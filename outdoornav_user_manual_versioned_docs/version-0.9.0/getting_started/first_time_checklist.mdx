...
[System Startup](./system_setup) for further
...
See [Connecting to Web UI](./system_setup#connecting_to_web_ui) for further
details.
...
[API Endpoints](../api/api_endpoints). You can also check the
...
[Connecting to Web UI](./system_setup#connecting_to_web_ui).

### ☐ Have you surveyed the Base Station?

See [RTK Survey Positioning](../cpr_hardware#base-station-survey) for
...
to [Checking GPS RTK Fix](../cpr_hardware#base-station-survey) for further
...
See [Set Datum](./system_setup#set-datum) for information on how
...
[Set Dock Location](./system_setup#set-dock-location) for information on
...
See [Web UI Manual Mode](../web_user_interface/ui_manual_mode) for further details
related to this.
...
[Mission Creation](../web_user_interface/ui_autonomous_mode#mission-creation).

### ☐ After creating a new mission, can you execute the mission?

To execute a mission refer to [Mission Execution](../web_user_interface/ui_autonomous_mode#mission-execution).
...
[Camera Views](../web_user_interface/ui_overview#camera-views).

### ☐ Can you select a camera and save an image after it loads on the main screen?

See [Pan-Tilt-Zoom (PTZ) View ](../web_user_interface/ui_overview#ptz-view) for more details related
to saving images.