...
For more specifics on the way Clearpath's configuration system launches the `velodyne_driver`, see the Velodyne [launch file](https://github.com/clearpathrobotics/clearpath_robot/blob/jazzy/clearpath_sensors/launch/velodyne_lidar.launch.py) and the [default parameter file](https://github.com/clearpathrobotics/clearpath_robot/blob/jazzy/clearpath_sensors/config/velodyne_lidar.yaml) in `clearpath_sensors`.
