...
For specifics on the way Clearpath's configuration system launches the camera, see the Intel Realsense [launch file](https://github.com/clearpathrobotics/clearpath_robot/blob/jazzy/clearpath_sensors/launch/intel_realsense.launch.py) and the [default parameter file](https://github.com/clearpathrobotics/clearpath_robot/blob/jazzy/clearpath_sensors/config/intel_realsense.yaml) in `clearpath_sensors`.
