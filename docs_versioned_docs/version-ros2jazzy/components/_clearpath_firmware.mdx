...
<Tabs groupId="platform">
  <TabItem
    ...
    default
  >
    The Husky A300 does not need any preparation for flashing firmware as it uses an Ethernet bootloader.
  </TabItem>
  <TabItem
    value="J100"
    label="J100"
  ...
  >
    ...
    Connect the MCU to the onboard computer using a micro-USB cable connected to the port as shown below:
