...
### New Features
- Added Lynx 1.0.0 firmware for A300 motor controllers (see [here](https://docs.clearpathrobotics.com/docs_robots/outdoor_robots/husky/a300/maintenance_husky#maintenance_husky_motor_controller_firmware) to update)
