...
[simulated](../tutorials/simulator) on an offboard computer to safely test software before
...
The offboard computer will need a copy of the [robot.yaml](../config/yaml) file to generate the same `setup.bash`
file as the robot.
