...
Make sure to set the correct controller type in your [robot.yaml](../config/yaml) file. See, [Joystick Controller](../config/yaml/platform/controller.mdx) setup in the Clearpath Configuration.
