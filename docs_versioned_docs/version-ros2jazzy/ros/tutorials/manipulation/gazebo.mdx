...
In this tutorial, we will cover using the MoveIt! Planning and Execution RViz plug-in to move arms to a predefined pose. We will use the A200 platform with a Kinova Gen3 Lite in the [Clearpath simulator](../simulator).
