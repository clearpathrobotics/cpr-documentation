...
If you prefer to add a URDF instead, then you can link it directly through the [`platform.extras`](platform/extras.mdx) entry.
<Mesh/>

## Sample

<details>
  <summary>Sample A200 Links Section</summary>
  <p>
