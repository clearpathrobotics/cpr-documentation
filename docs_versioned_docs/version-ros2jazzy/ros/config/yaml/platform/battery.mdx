...
be launched as part of the platform service. For batteries without a BMS, the [battery state estimator](https://github.com/clearpathrobotics/clearpath_robot/blob/jazzy/clearpath_diagnostics/clearpath_diagnostics/battery_state/battery_state_estimator)
