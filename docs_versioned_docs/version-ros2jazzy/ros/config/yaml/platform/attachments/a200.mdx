...
#### Observer Backpack
The Observer backpack is a large enclosure with multiple mounting locations for additional sensors. It is used by the [Husky A200 Observer](/docs_robots/solutions/husky_observer/).
