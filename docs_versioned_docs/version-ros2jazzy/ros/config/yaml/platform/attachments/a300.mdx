...
The **default** top plate is mounted on top of the robot. When properly installed it provides IP54 protection.
<A300TopPlateDefault/>
<br/>

### PACS
The **PACS** top plate has a grid of mounting holes in it, using the PACS-compatible **80mm x 80mm** spacing.
Because of the number of mounting holes, the PACS top plate is not IP54 rated.
<A300TopPlatePacs/>
<br/>
