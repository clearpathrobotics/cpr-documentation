...
2. [**platform**](./platform) level configurations such as robot specific mounting structures and parameters.
...
5. [**sensors**](./sensors) are selected from an inventory of Clearpath supported sensors.
