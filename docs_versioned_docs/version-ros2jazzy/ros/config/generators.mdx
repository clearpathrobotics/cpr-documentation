...
launch files, and parameter files. Each file type has a generator which will use the [Clearpath Config](/docs/ros#terminology) to figure out which files need to
