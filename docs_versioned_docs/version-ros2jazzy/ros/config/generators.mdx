...
launch files, and parameter files. Each file type has a generator which will use the [Clearpath Config](../ros.mdx#terminology) to figure out which files need to
