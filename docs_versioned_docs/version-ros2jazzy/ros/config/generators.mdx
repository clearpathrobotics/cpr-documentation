...
launch files, and parameter files. Each file type has a generator which will use the [Clearpath Config](../ros2-overview#terminology) to figure out which files need to
