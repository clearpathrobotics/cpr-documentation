...
| USB 3.0 Hub, 7 port, 9 - 24 VDC, PACS&trade; kit |                          027642                          |
...
<center>
  <figure>
    <img
      ...
      width="400"
    />
    <figcaption>017642 | USB 3.0 Hub, 7 port, PACS&trade; kit</figcaption>
  </figure>
</center>
...
| :-: | :-------------------------------------- | :------------------------------------------------------: | :------: |
|  1  | Kit, Attachment—80 X 80, DIN Rail       |           [027881](../add-ons/din_rail)           |    1     |
...
1.  Build the DIN rail assembly. The instructions are listed on the [DIN Rail page](../add-ons/din_rail)
