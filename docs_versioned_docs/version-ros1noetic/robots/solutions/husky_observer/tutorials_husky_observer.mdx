...
For details on updating Husky Observer software or firmware, refer to [Software Maintenance](/docs/robots/solutions/husky_observer/maintenance_husky_observer#software_maintenance).
