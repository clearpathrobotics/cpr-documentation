...
Refer to the [Husky Tutorials](../../../robots/outdoor_robots/husky/tutorials_husky#husky-ros-packages) for additional details.
...
As Husky Observer is built on top of the Husky base robot, you can follow the [Husky Tutorials](../../../robots/outdoor_robots/husky/tutorials_husky#simulating-husky)
...
See also [Additional Simulation Worlds](../../../robots/outdoor_robots/husky/tutorials_husky#additional-sim).
...
[Husky Tutorials](../../../robots/outdoor_robots/husky/tutorials_husky#interfacing-with-husky)
...
3. Using the controller for teleoperation. See [Husky Tutorials](../../../robots/outdoor_robots/husky/tutorials_husky#driving-with-remote-controller).
4. Publishing ROS messages. See [Husky Tutorials](../../../robots/outdoor_robots/husky/tutorials_husky#driving-with-ros-messages).

### Keeping Husky Observer Updated

For details on updating Husky Observer software or firmware, refer to [Software Maintenance](maintenance_husky_observer#software_maintenance).

---

## Testing Base Husky

See [Husky Tutorials](../../../robots/outdoor_robots/husky/tutorials_husky#testing-husky) for
