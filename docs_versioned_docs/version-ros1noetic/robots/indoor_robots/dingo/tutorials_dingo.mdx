...
| `/mcu/aux_input`     | `dingo_msgs/UInt8`    | User can subscribe to this topic to monitor the MCU user inputs. See [AUX Inputs](integration_dingo/integration_dingo.mdx#dingo-aux-inputs).                                                        |
| `/mcu/aux_output`    | `std_msgs/UInt8`      | User can publish to this topic to enable and disable the AUX outputs as well as control relays on the MCU. See [AUX Outputs and Relays](integration_dingo/integration_dingo.mdx#dingo-aux-outputs). |
| `/mcu/fans`          | `dingo_msgs/Fans`     | User can publish to this topic to control an optionally installed fan. See details [Optional Fan](integration_dingo/integration_dingo.mdx#dingo-fan).                                               |
...
1.  Using the provided PS4 controller.
    Refer to the [User Manual](user_manual_dingo.mdx#controller) details on how to use the controller.
...
For details on updating Dingo software or firmware, refer to [Software Maintenance](maintenance_dingo.mdx#software_maintenance).
