...
import ComponentIntroductionDingo from "/docs_versioned_docs/version-ros1noetic/components/introduction_dingo.mdx";
import ComponentSupport from "/docs_versioned_docs/version-ros1noetic/components/support.mdx";
import ComponentUsingRos from "/docs_versioned_docs/version-ros1noetic/components/using_ros.mdx";
import ComponentWiredRobotConnection from "/docs_versioned_docs/version-ros1noetic/components/wired_robot_connection.mdx";
import ComponentWifiRobotConnection from "/docs_versioned_docs/version-ros1noetic/components/wifi_robot_connection.mdx";
import ComponentRemoteRosConnectivity from "/docs_versioned_docs/version-ros1noetic/components/remote_ros_connectivity.mdx";
import ComponentCommonSafeWorkProcedures from "/docs_versioned_docs/version-ros1noetic/components/common_safe_work_procedures.mdx";
import ComponentSafetyWarning from "/docs_versioned_docs/version-ros1noetic/components/safety_warning.mdx";
...
Dingo provides a DC Shore Power connection ([internal connector for Dingo 1.0](./integration_dingo#dingo-payload-electrical-integration); [external connector for Dingo 1.5](#dingo-exterior-features))
...
If not, or to set up your own Onboard Computer, see the [Dingo Tutorials](./tutorials_dingo).
...
See the [Dingo Tutorials](./tutorials_dingo#dingo-networking) for details.
...
If your controller has become unpaired or if you wish to pair a new controller, following the instructions in the [Dingo Tutorials](./tutorials_dingo#pairing-the-controller).
...
See [Optional External Motion Stop](./integration_dingo#dingo-external-motion-stop) for details on adding an external motion-stop button/switch.
