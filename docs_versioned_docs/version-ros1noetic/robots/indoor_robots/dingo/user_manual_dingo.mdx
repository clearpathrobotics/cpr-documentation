...
See the [Dingo Tutorials](tutorials_dingo.mdx#dingo-networking) for details.
...
If your controller has become unpaired or if you wish to pair a new controller, following the instructions in the [Dingo Tutorials](tutorials_dingo.mdx#pairing-the-controller).
