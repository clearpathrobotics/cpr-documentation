...
1.  Using the provided PS4 controller.
    Refer to the [User Manual](user_manual_ridgeback.mdx#controller) details on how to use the controller.
...
For details on updating Ridgeback software or firmware, refer to [Software Maintenance](maintenance_ridgeback.mdx#software_maintenance).
