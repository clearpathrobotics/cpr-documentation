...
1.  Using the provided Fubata controller.
    Refer to the [User Manual](user_manual_warthog.mdx#controller) details on how to use the controller.
...
Refer to [Pinch Points](user_manual_warthog.mdx#warthog-pinch-points) for
...
For details on updating Warthog software or firmware, refer to [Software Maintenance](maintenance_warthog.mdx#software_maintenance).
