...
These top plates require [extrusion rails](extrusion_rails_warthog.mdx) to be mounted on the Warthog.

:::

:::note

You can install an [extrusion cross-bar](extrusion_crossbar_warthog.mdx) under the top plates to add stiffness.
