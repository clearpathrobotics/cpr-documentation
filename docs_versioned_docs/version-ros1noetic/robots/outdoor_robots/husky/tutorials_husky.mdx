...
[Using Husky](#using-husky) describes how to simulate and drive your Husky. [Simulation](#simulating-husky)
...
[Navigating Husky](#navigating-husky) is a follow-on to what is learned in the [Simulation](#simulating-husky)
  ...
  <gazebo reference="front_realsense">
    ...
    <sensor type="depth" name="front_realsense_depth">
      ...
      <camera>
        ...
        <clip>
          <!-- give the colour sensor a maximum range of 50m so that the simulation renders nicely -->
          <near>0.01</near>
          <far>50.0</far>
        </clip>
      </camera>
