...
1. Using the provided PS4 or Logitech controller. Refer to the [User Manual](user_manual_husky.mdx#controller)
...
For details on updating Husky software or firmware, refer to [Software Maintenance](maintenance_husky.mdx#software_maintenance).
