...
If you are upgrading your robot from an older version of ROS, please refer to our instructions for upgrading to [Melodic](https://clearpathrobotics.com/assets/guides/kinetic/kinetic-to-melodic/index.html), [Noetic](https://clearpathrobotics.com/assets/guides/melodic/melodic-to-noetic/index.html) or [ROS 2](/docs/ros/installation/robot) (if applicable).
