...
On the robot PC, run the following commands:
...
<Tabs groupId="platform">
  ...
  <figure>
    ...
    <ol>
      ...
      <li>
        The mini-USB port used for transmitting data. This should be connected to J100's PC for both normal operation and  firmware flashing.
      </li>
    </ol>
  </figure>
  ...
  **Place the J100 MCU into bootloader mode**
  ...
  Open the lid of the robot to expose the MCU and make sure the mini-USB cable is connected to the robot PC.
