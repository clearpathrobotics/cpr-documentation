...
This allows you to add or remove manipulator from your robot's software configuration by modying the [robot configuration yaml](../../../../ros/config/yaml/sensors/overview.mdx).
