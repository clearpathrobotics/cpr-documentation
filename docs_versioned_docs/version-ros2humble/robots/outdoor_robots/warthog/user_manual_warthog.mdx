...
If you need to reinstall the software on it, refer to the [Warthog Tutorials](./tutorials_warthog).
...
Ethernet cable. See the [Warthog Tutorials](./tutorials_warthog) for details
