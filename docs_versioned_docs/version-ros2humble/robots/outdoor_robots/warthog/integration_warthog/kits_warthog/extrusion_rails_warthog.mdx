...
Please email <research-sales@clearpathrobotics.com> if you want Clearpath's team to design a bracket structure for your application.
...
- Rivet installation tool (Refer to our [Physical Tools](../../../../common/physical_tools) page for a suggested rivet installation tool)
