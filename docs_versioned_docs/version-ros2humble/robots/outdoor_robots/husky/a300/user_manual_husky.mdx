...
| :----------- | :------- | :------------------|
| 0 kg         | 15°      | 0.25 m/s or less (TODO: confirm) |
| 100 kg       | 15°      | 0.5 m/s or less  (TODO: confirm) |
...
| Operating Time, Average⁵       | 4 hours (standard battery) or 8 hours (upgraded battery) or 12 hours (extended battery) |
| Operating Time, Standby        | 12 hours (standard battery) or 24 hours (upgraded battery) or 36 hours (extended battery) |
| Battery                        | 40 Ah @ 25.6 V (standard) or 80 Ah @ 25.6 V (upgraded) or 120 Ah @ 25.6 V (extended), LiFePO<sub>4</sub>   |
| Standard Battery Charger       | 10 A; short-circuit, over-current, over-voltage and reverse voltage protection |
| Charge Time⁶                   | 3-4 hours (standard battery) or 7-8 hours (upgraded battery) or 8-10 hours (extended battery)            |
...
The MCU handles power supply monitoring and motor control. (TODO: update if MCU no longer handles motor control.)
...
- Husky A300 Standard Manual Charger (Henryuan Model PSY29210000): 300 W, indoor use only
