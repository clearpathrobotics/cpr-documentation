...
rapid deployments, and deployments.
...
- Two, four, or six LiFePO<sub>4</sub> batteries
- One battery charger
- One PS4 remote control
- Lockout Keys (2X)
- Integrated computer
- Integrated IMU
...
Warthog includes four RGB status lights, one on each corner of the chassis. These lights
...
- Power, Restart, and Emergency Stop buttons
- Lockout
...
TODO: note on shore power
TODO: note on available chargers

#### Debug Ports

TODO: Ethernet, USB, and HDMI debug ports

#### Airflow Intake and Exhaust

TODO: Cooling ingress and egress ports
...
If not, or to set up your own Onboard Computer, see the [Husky Tutorials](tutorials_husky).
...
[Husky Tutorials](tutorials_husky).
