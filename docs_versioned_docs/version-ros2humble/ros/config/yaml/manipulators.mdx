...
import Franka from "/docs_versioned_docs/version-ros2humble/components/yaml/manipulators/franka.mdx";
import FrankaGripper from "/docs_versioned_docs/version-ros2humble/components/yaml/manipulators/franka_gripper.mdx";
