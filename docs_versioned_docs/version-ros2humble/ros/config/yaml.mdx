...
system:
  ...
  ros2:
    ...
    domain_id: 0
    rmw_implementation: rmw_fastrtps_cpp
    workspaces: [/home/administrator/clearpath_ws/install/setup.bash]
```
...
Every robot platform has unique structures such as versatile sensor mounting solutions, wireless charging receivers, and waterproofing enclosures; we refer to these as decorations.
