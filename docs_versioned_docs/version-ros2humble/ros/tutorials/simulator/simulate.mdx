...
The launch file will run all of the necessary [generators](../../config/generators) to generate launch and parameter
...
The simulated robot can be driven in the same ways as the physical robot. Take a look at the [Teleop](../driving)
