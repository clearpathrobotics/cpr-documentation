...
This section only applies to platforms with corner lights (D1X0, W200, R100).

:::

Corner lighting is unified for platforms that support it. Lighting is controlled by the [lighting node](https://github.com/clearpathrobotics/clearpath_common/tree/humble/clearpath_platform/src/lighting) which defines multiple lighting states.
