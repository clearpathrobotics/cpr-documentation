...
Make sure to set the correct controller type in your [robot.yaml](../config/yaml.mdx) file. See, [Joystick Controller](../config/yaml.mdx#joystick-controller) setup in the Clearpath Configuration.
