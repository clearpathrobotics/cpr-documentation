...
wait for the Ubuntu login prompt to show up. On a fresh install, the default username and password are
both `ubuntu`. You will be prompted to change your password.
