...
Refer to the [Mini ITX troubleshooting page](/docs/add-ons/computers/mini_itx).
...
2.  If the voltage is correct, then review the [Troubleshooting section for the related sensor](/docs/add-ons/sensors).
