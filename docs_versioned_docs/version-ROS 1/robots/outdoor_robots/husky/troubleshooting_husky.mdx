...
import ComponentSupportIntroduction from "/docs_versioned_docs/version-ROS 1/components/support_introduction.mdx";
...
- The USB-Serial cable is not connected.
  ...
  Check that the DE-9 end is seated on it's [jack in the Husky user bay](./user_manual_husky/#husky_user_manual_pinout).
...
Refer to the [Networking page](../../../ros/networking).

### Cannot connect to the robot's computer over a network cable

Reter to the [Networking page](../../../ros/networking).
...
Refer to the [Mini ITX troubleshooting page](../../accessories/computers/mini_itx).
...
2.  If the voltage is correct, then review the [Troubleshooting section for the related sensor](../../accessories/sensors).
