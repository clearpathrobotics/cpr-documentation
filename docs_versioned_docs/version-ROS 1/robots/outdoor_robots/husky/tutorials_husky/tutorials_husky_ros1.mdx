...
import ComponentIntroductionHusky from "/docs_versioned_docs/version-ROS 1/components/introduction_husky.mdx";
...
1. Using the provided PS4 or Logitech controller. Refer to the [User Manual](../user_manual_husky/#controller)
...
For details on updating Husky software or firmware, refer to [Software Maintenance](../maintenance_husky#software_maintenance).
