...
import ComponentNetplanSetup from "/docs_versioned_docs/version-ROS 1/components/netplan_setup.mdx";
...
Please see [Electrical Integration](./integration_warthog/#warthog-electrical-integration) for more information.
...
For more information and guidance on mounting payload structures on top of Warthog, please refer to subsection [Mechanical Mounting](./integration_warthog/#warthog-mechanical-mounting).
...
If you need to reinstall the software on it, refer to the [Warthog Tutorials](./tutorials_warthog#warthog-software-setup).
...
Ethernet cable. See the [Warthog Tutorials](./tutorials_warthog#warthog-networking) for details
