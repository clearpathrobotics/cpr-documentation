...
import ComponentIntroductionJackal from "/docs_versioned_docs/version-ROS 1/components/introduction_jackal.mdx";
import ComponentRos1ToRos2UpgradePrep from "/docs_versioned_docs/version-ROS 1/components/ros1_to_ros2_upgrade_prep.mdx";
...
import ComponentInstallingRobotSoftwareRos2 from "/docs_versioned_docs/version-ROS 1/components/installing_robot_software_ros2.mdx";
import ComponentRemoteRos2Connection from "/docs_versioned_docs/version-ROS 1/components/remote_ros2_connection.mdx";
...
For details on updating Jackal software or firmware, refer to [Software Maintenance](../maintenance_jackal#software_maintenance).
