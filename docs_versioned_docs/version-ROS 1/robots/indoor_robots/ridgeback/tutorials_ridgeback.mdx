...
import ComponentIntroductionRidgeback from "/docs_versioned_docs/version-ROS 1/components/introduction_ridgeback.mdx";
...
1.  Using the provided PS4 controller.
    Refer to the [User Manual](./user_manual_ridgeback/#controller) details on how to use the controller.
...
For details on updating Ridgeback software or firmware, refer to [Software Maintenance](./maintenance_ridgeback#software_maintenance).
