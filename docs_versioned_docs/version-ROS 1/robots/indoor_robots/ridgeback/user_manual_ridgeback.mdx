...
in [Electrical Integration](./integration_ridgeback#ridgeback-payload-electrical-integration).
...
See [Network IP Addresses](../../../../ros/networking/network_ip_addresses) for a full list of common IP addresses.
...
[Mechanical Integration](./integration_ridgeback#ridgeback-payload-mechanical-integration).
...
Then, see [Ridgeback Tutorials](./tutorials_ridgeback#ridgeback-networking) for details
...
[Ridgeback Tutorials](./tutorials_ridgeback#pairing-the-controller).
...
See [Optional External Motion Stop](./integration_ridgeback#ridgeback-external-motion-stop)
