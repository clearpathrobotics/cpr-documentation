...
in [Exterior Features](../user_manual_dingo#dingo-exterior-features), which can be used for attaching external payloads.
...
- [Top Plate](./kits/top_plate_dingo)
- [Riser Full](./kits/riser_full_dingo)
