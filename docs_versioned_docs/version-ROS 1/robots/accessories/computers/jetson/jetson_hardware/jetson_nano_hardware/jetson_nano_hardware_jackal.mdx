...
import ComponentJackalComputerRemoval from "/docs_versioned_docs/version-ROS 1/components/jackal_remove_miniitx.mdx";
...
5. Make a power cable that connects to the 12 V user
   ...
   to the [Jackal User Manual](../../../../../outdoor_robots/jackal/user_manual_jackal) for the
