...
| :-: | :-------------------------------------- | :------------------------------------------------------: | :------: |
|  1  | Kit, Attachment—80 X 80, DIN Rail       |           [027881](/docs/add-ons/accessories/din_rail)           |    1     |
...
1.  Build the DIN rail assembly. The instructions are listed on the [DIN Rail page](/docs/add-ons/accessories/din_rail)
