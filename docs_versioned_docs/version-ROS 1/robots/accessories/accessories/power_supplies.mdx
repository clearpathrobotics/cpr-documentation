...
- [TurtleBot4](../../learing_platforms/turtlebot4/user_manual_turtlebot4)
...
8. Review the Power Supply's datasheet, looking for mechanical mounting as well as shock & vibration requirements.
   ...
   2. There are Power Supplies that include mounting brackets for [DIN Rails](./accessories/din_rail), which could simplify your integration.
