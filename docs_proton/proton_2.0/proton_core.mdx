...
Serial transport is more involved, requiring stream synchronization and integrity checking. See [the transport framing](../index#serial-transport) for more information on formatting.
