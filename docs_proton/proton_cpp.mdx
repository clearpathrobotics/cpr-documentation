...
**proton_cpp** utilizes the Protobuf compiler to generate C++ classes for the Bundle and Signal protobufs. Then, much like **protonc**, it wraps these classes with the `BundleHandle` and `SignalHandle` classes.
...
**proton_cpp** can be added to a CMake project much like [protonc](./protonc.mdx#fetch-proton). The Proton repo is fetched and made available to the project:
