...
documention portal, under the [Computers](../../accessories/computers/computers.mdx), [Sensors](../../accessories/sensors/sensors.mdx), [Manipulators](../../accessories/manipulators/manipulators.mdx),
...
[Jackal ROS 1 Tutorials](tutorials_jackal.mdx#jackal-software-setup).
...
ethernet cable. See the [Jackal ROS 1 Tutorials](tutorials_jackal.mdx#jackal-networking) for details
...
the [Jackal ROS 1 Tutorials](tutorials_jackal.mdx#pairing-the-controller).
