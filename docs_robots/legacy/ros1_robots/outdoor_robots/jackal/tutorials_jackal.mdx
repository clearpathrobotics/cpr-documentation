...
1.  Using the provided PS4 controller.
    Refer to the [User Manual](user_manual_jackal.mdx#controller) details on how to use the controller.
...
For details on updating Jackal software or firmware, refer to [Software Maintenance](maintenance_jackal.mdx#software_maintenance).
