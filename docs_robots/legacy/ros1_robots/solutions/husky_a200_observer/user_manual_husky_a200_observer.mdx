---
title: Husky A200 Observer User Manual
...
import ComponentIntroductionHuskyObserver from "/components/introduction_husky_a200_observer.mdx";
...
Husky A200 Observer is a fully integrated system that enables robotics developers to accelerate inspection solutions.
Built on top of the versatile [Husky A200](../../../ros1_robots/outdoor_robots/husky/user_manual_husky.mdx) base platform,
Husky A200 Observer enables robotics developers to fast-track their system development. With it, you can get your test
...
Your Husky A200 Observer shipment contains the following:

- Husky A200 Observer robot
- Lockout keys (2X)
...
If you purchased standard payload modules or custom integration services with Husky A200 Observer, then additional equipment will
...
Husky A200 Observer is built around a computer running Ubuntu, paired with a 32-bit microcontroller MCU.
...
The Husky A200 Observer exterior is shown below and includes:
...
<center>
  <figure>
    <img
      src="/img/robot_images/husky_a200_observer_images/front_wireframe_with_labels.png"
      width="800"
    />
    <figcaption>Husky A200 Observer exterior, front view</figcaption>
  </figure>
</center>
...
<center>
  <figure>
    <img
      src="/img/robot_images/husky_a200_observer_images/rear_wireframe_with_labels.png"
      width="800"
    />
    <figcaption>Husky A200 Observer exterior, rear view</figcaption>
  </figure>
</center>
...
The stack lights can be muted by calling the `/lights/set_stack_mute` service with a value of True.  Users can also override Idle, Teleop and 
Autonomous LED patterns by publishing to the `/lights/custom_stack_pattern` topic at 2Hz or faster. This topic takes a StackLightState message 
object as input which consists of the following parameters:

- `RYG color` - The RYG color of the stack light's top light
- `bool strobe_on` - Boolean flag for whether the strobe light is on or not
- `string message` - Human readable message for this particular stack light state

The charging, error and warning states will override any custom patterns.
...
the chassis that provides information about the current status of Husky A200 Observer. The indicators are described in the table below.

|                                   Icon                                   | Description                                                                                                                                                                                                                                                                                                            |
| :----------------------------------------------------------------------: | :--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| <img src="/img/robot_images/husky_images/robot_husky_3.png" width="50"/> | **Battery Status** This is not used on Husky A200 Observer. Refer to the battery state indicator in the OutdoorNav UI or on the stack light instead.                                                                                                                                                                   |
| <img src="/img/robot_images/husky_images/robot_husky_4.png" width="50"/> | **Communication Status** When green, Husky A200 Observer is receiving a stream of correctly-formatted motion commands, and is ready to drive. When yellow, Husky A200 Observer is receiving commands, but will not drive due to motion stop or another error. When red, serial communications are currently timed-out. |
| <img src="/img/robot_images/husky_images/robot_husky_5.png" width="50"/> | **General Error Status** Illuminates red when Husky A200 Observer will not drive due to an error state. Such states include motion stop, insufficient battery power, or an unspecified software error.                                                                                                                 |
| <img src="/img/robot_images/husky_images/robot_husky_6.png" width="50"/> | **Motion Stop Status** Illuminates red when Husky A200 Observer will not drive due to the motion stop being activated, either onboard or wireless (if available).                                                                                                                                                      |
...
<center>
  <figure>
    <img
      src="/img/robot_images/husky_a200_observer_images/main_power_switch.png"
      width="500"
    />
    <figcaption>Husky A200 Observer ON/OFF switch</figcaption>
  </figure>
</center>
...
In addition to the motion-stop buttons on the robot, if your Husky A200 Observer is equipped with a wireless motion-stop function,
...
Additional payloads can be integrated with Husky A200 Observer, either as part of your purchase or installed after receiving your Husky A200 Observer.
Refer to [Husky A200 Observer Integration](integration_husky_a200_observer.mdx) for details on how to integrate your own payload or how to integrate a payload kit from Clearpath Robotics.
Each payload kit that ships from Clearpath Robotics comes with a custom mounting bracket and cabling for easy attachment to Husky A200 Observer.
...
Husky A200 Observer's front is shown.
...
<center>
  <figure>
    <img
      src="/img/robot_images/husky_a200_observer_images/robot_coordinate_system.png"
      width="500"
    />
    <figcaption>Husky A200 Observer orientation references</figcaption>
  </figure>
</center>
...
<center>
  <img
    src="/img/robot_images/husky_a200_observer_images/husky_a200_observer_dimensions.png"
    width="1000"
  />
</center>
...
<center>
  <img
    src="/img/robot_images/husky_a200_observer_images/safety_information.png"
    width="800"
  />
</center>
...
| :----------------------------------------------------------------------------------: | ----------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
|  <img src="/img/robot_images/husky_a200_observer_images/automatic_motion_hazard.png" />   | Automatic Motion Hazard       | Clearpath Robotics robots may suddenly begin moving autonomously or when being driven manually. Always be aware of Clearpath Robotics products and their potential for movement.                                   |
|      <img src="/img/robot_images/husky_a200_observer_images/crushing_hazard.png" />       | Crushing Risk                 | Objects or personnel can be crushed between the Clearpath Robotics robot and another object. Keep hands and other objects clear of crush points at all times. Keep clear of all docking Clearpath Robotics robots. |
|  <img src="/img/robot_images/husky_a200_observer_images/electrical_shock_hazard.png" />   | Electrical Shock Risk         | Clearpath Robotics robots contain circuitry and batteries that may cause electrical shock if not properly insulated.                                                                                               |
|    <img src="/img/robot_images/husky_a200_observer_images/entanglement_hazard.png" />     | Entanglement Risk             | Clearpath Robotics robots as well as their sensors can lead to entanglement for hair or dangling materials during their rotation. Keep dangling materials/hair away from Clearpath Robotics robots during motion.  |
|    <img src="/img/robot_images/husky_a200_observer_images/environmental_hazard.png" />    | Environmental Hazard          | Clearpath Robotics robots contain batteries and materials that may require special disposal methods. Consult local regulations.                                                                                    |
|   <img src="/img/robot_images/husky_a200_observer_images/falling_object_hazard.png" />    | Falling Object Risk           | Beware of objects that may have shifted in any Clearpath Robotics robot crate as they pose a risk of falling when opened.                                                                                          |
|  <img src="/img/robot_images/husky_a200_observer_images/high_surface_temp_hazard.png" />  | High Surface Temperature Risk | Robot PC heat sinks and robot motors can become extremely hot during operation.                                                                                                                                    |
|       <img src="/img/robot_images/husky_a200_observer_images/impact_hazard.png" />        | Impact Risk                   | Clearpath Robotics robots travelling through a facility can potentially impact objects and personnel. Keep clear of all docking Clearpath Robotics robots.                                                         |
|   <img src="/img/robot_images/husky_a200_observer_images/laser_radiation_hazard.png" />   | Laser Radiation Risk          | Clearpath Robotics robots may use Class 1 laser products. These provide no hazard during normal use, however it is not recommended to stare directly into the beam(s).                                             |
|  <img src="/img/robot_images/husky_a200_observer_images/material_hazard_lithium.png" />   | Material Hazard - Lithium     | Robot batteries contain harmful material. Always use proper handling procedures when handling robot batteries.                                                                                                     |
| <img src="/img/robot_images/husky_a200_observer_images/manual_load_lifting_hazard.png" /> | Manual Load Lifting Risk      | Always use ergonomic techniques when manually lifting loads.                                                                                                                                                       |
|      <img src="/img/robot_images/husky_a200_observer_images/pinching_hazard.png" />       | Pinching Risk                 | Keep hands and other objects clear of pinch points at all times. Keep clear of all docking Clearpath Robotics robots.                                                                                              |
|   <img src="/img/robot_images/husky_a200_observer_images/radio_frequency_hazard.png" />   | Radio Frequency Risk          | Clearpath Robotics robots and/or accesories may use radio frequency (RF) radiating antennas. These provide no hazard during normal use, however prolonged exposure around the antenna is not recommended.          |
|      <img src="/img/robot_images/husky_a200_observer_images/tripping_hazard.png" />       | Tripping Hazard               | Clearpath Robotics products may pose a tripping hazard.                                                                                                                                                            |
...
<center>
  <img
    src="/img/robot_images/husky_a200_observer_images/caution_awareness.png"
    width="800"
  />
</center>
...
<center>
  <img
    src="/img/robot_images/husky_a200_observer_images/impact_awareness.png"
    width="800"
  />
</center>
...
### Husky A200 Observer Safety Notices

<center>
  <img
    src="/img/robot_images/husky_a200_observer_images/autonomous_robot_danger.png"
    width="800"
  />
</center>
...
Husky A200 Observer is powered by two 12 V Lithium-Iron-Phosphate (LiFePO<sub>4</sub>) batteries in series to make a 24 V pack.
These batteries are similar to the type found in electric wheelchairs, golf carts, fork trucks, and other devices.
Husky A200 Observer's battery pack is capable of delivering 5565 W, three times the power of a standard wall outlet.
This gives Husky A200 Observer's motors their great performance, however, it is also enough power to cause severe bodily harm.

Note that the Husky A200 Observer PDU has a 50 A fuse that limits the continuous power output to 1325 W.

Please observe the following precautions:

- Turn the Main Power Switch to "OFF" when working on Husky A200 Observer's hardware.
...
For the safety of users and to maximize the lifetime of Husky A200 Observer, please observe the following when manually transporting the robot:

- Husky A200 Observer should be lifted by two persons, firmly gripping the front and rear bumper-bars.
- Ensure that Husky A200 Observer is in Motion-Stop mode when transporting short distances and powered off when transporting longer distances.
- It is not advised to push Husky A200 Observer, as this can cause damage to the motors.

#### Performance Considerations

Included in Husky A200 Observer are native software checks and limits to protect the robot.
...
Husky A200 Observer's motors are rated to draw 10.7 A continuous, but they will spike to several times higher than this,
...
Husky A200 Observer's motors.

### Husky A200 Observer Safety Features
...
<center>
  <figure>
    <img
      src="/img/robot_images/husky_a200_observer_images/motion_stop_button_locations.png"
      width="400"
    />
    <figcaption>Husky A200 Observer motion-stop buttons</figcaption>
  </figure>
</center>
...
<center>
  ...
  <figure>
    <img
      src="/img/robot_images/husky_a200_observer_images/wireless_stop_override_keyswitch.png"
      width="500"
    />
...
When Husky A200 Observer is in motion in any direction, both in manual and autonomous modes, a buzzer will sound
...
<center>
  <figure>
    <img
      src="/img/robot_images/husky_a200_observer_images/vlp16_fov.png"
      width="400"
    />
...
<center>
  <img
    src="/img/robot_images/husky_a200_observer_images/base_station_caution.png"
    width="800"
  />
</center>
...
<center>
  <img
    src="/img/robot_images/husky_a200_observer_images/dock_weight_caution.png"
    width="800"
  />
</center>
...
<center>
  <figure>
    <img
      src="/img/robot_images/husky_a200_observer_images/charge_dock.png"
      width="400"
    />
...
<center>
  <figure>
    <img
      src="/img/robot_images/husky_a200_observer_images/charge_dock_and_robot.png"
      width="600"
    />
...
The WiBotic wireless receiver ships pre-installed on the Husky A200 Observer robot
...
<center>
  <figure>
    <img
      src="/img/robot_images/husky_a200_observer_images/handling_danger.png"
      width="600"
    />
  </figure>
</center>
...
<center>
  <figure>
    <img
      src="/img/robot_images/husky_a200_observer_images/crate_warning.png"
      width="600"
    />
  </figure>
</center>
...
Husky A200 Observer is always being operated within range of WiFi networks.
Note that the SIM card (and corresponding data plan) is provided by the end user,
not by Clearpath Robotics.

1. Open the lid on Husky A200 Observer.
2. Locate the "Microhard" component, near the rear-left corner.
3. Insert the SIM card into the Microhard port labelled "SIM 1".
4. Refer to [Enabling LTE (Cellular) Networking on Robot](#lte-setup) for details on the software setup.
...
<center>
  <figure>
    <img
      src="/img/robot_images/husky_a200_observer_images/on_off_switch.png"
      width="600"
    />
...
<center>
  <figure>
    <img
      src="/img/robot_images/husky_a200_observer_images/battery_level_warning.png"
      width="600"
    />
  </figure>
</center>
...
See [Maintenance](./maintenance_husky_a200_observer#charging) for details on charging the robot.
...
to the main computer. See [Husky A200 Observer Integration](integration_husky_a200_observer.mdx)
for further details.
...
During setup or debugging, it may be desirable to connect to Husky A200 Observer through a wired Ethernet connection.
...
To use your controller, it must be paired with your Husky A200 Observer and powered on.
Note that your controller is already paired with your Husky A200 Observer when it ships.
...
To teleoperate Husky A200 Observer, first release the motion stop. Then, referring to the following image, press the
enable button (either slow or turbo mode) and use the left thumbstick to drive Husky A200 Observer.
...
Both the PTZ camera and the driving lights can also be controlled through the controller. While holding the 
X button the left thumbstick controls the Pan and Tilt of the camera. While holding the O button the left thumbstick 
controls the zoom. The D-Pad is used to control the driving lights, with the top button controlling the front driving 
lights and the bottom button controlling the rear driving lights.
...
To monitor and control Husky A200 Observer, it must be integrated into a communication network. The main
requirements are:

1. The user control device (tablet or laptop) must have network connectivity to the Husky A200 Observer,
...
modes for deploying Husky A200 Observer, which are outlined below.
...
<center>
  <figure>
    <img
      src="/img/robot_images/husky_a200_observer_images/onav_network_base_station_mode.png"
      width="600"
    />
  ...
  <figure>
    <img
      src="/img/robot_images/husky_a200_observer_images/onav_network_customer_network_mode.png"
      width="800"
    />
  ...
  <figure>
    <img
      src="/img/robot_images/husky_a200_observer_images/onav_network_cellular_only_mode.png"
      width="400"
    />
    <figcaption>
      Cellular Only Mode
      <br />(<a href="https://www.flaticon.com/free-icons/wifi" title="wifi icons">
...
<center>
  <figure>
    <img
      src="/img/robot_images/husky_a200_observer_images/microhard_wwan_settings.png"
      width="800"
    />
  ...
  <figure>
    <img
      src="/img/robot_images/husky_a200_observer_images/microhard_loadbalancer.png"
      width="800"
    />
...
Refer to the [OutdoorNav User Manual](/docs_outdoornav_user_manual/web_user_interface/ui_overview#config-general-settings)
...
This step is optional. It is only for users attempting to access Husky A200 Observer over the internet.

:::

When attempting to access Husky A200 Observer over the internet, it can sometimes be difficult to determine the
...
Husky A200 Observer robot) appear to be hosted on a subdomain of ngrok.com, meaning that no public IP or domain
name on Husky A200 Observer is needed. While the ngrok tools are pre-installed on Husky A200 Observer, a small amount
...
1. Connect an Ethernet cable from the configured port on your laptop to the
   debug/expansion port on the top of the robot.
1. SSH to the robot: `ssh administrator@192.168.131.1`. (See [Appendix A](#networking-configuration) for credentials.)
...
1. Run `ngrok config edit` to set up a tunnel for your subdomain to port 80 on Husky A200 Observer, where the
...
The Husky A200 Observer optionally ships with a Getac ruggedized tablet as shown in below.

<center>
  <figure>
    <img
      src="/img/robot_images/husky_a200_observer_images/getac.png"
      width="300"
    />
...
has network connectivity to the Husky A200 Observer as described in
...
are strongly recommended when attempting to operate Husky A200 Observer autonomously.
...
Husky A200 Observer has been validated with the [SwiftNav Skylark](https://www.swiftnav.com/skylark)
...
1. Configure the "position" SwiftNav Duro to communicate with the Skylark service.
   ...
   1. "Connect to Device" using "TCP/IP" with "Host" `192.168.131.31` and port `55555`.
      <img
        src="/img/robot_images/husky_a200_observer_images/swift_console_connect.png"
        width="500"
      />
   1. In the "Settings" tab:
      ...
      1. Under "ethernet", set the "gateway" to `192.168.131.51`, which
         ...
         <img
           src="/img/robot_images/husky_a200_observer_images/swift_console_settings_ethernet.png"
           width="700"
         />
      1. Under "ntrip", set "enable" to `True` and then fill in the remaining fields using
         ...
         <img
           src="/img/robot_images/husky_a200_observer_images/swift_console_settings_ntrip.png"
           width="700"
         />
   ...
   1. In the "Observations" tab, confirm that RTK corrections from Skylark are being received.<br/>
      <img
        src="/img/robot_images/husky_a200_observer_images/swift_console_observations.png"
        width="700"
      />
...
<center>
  <figure>
    <img
      src="/img/robot_images/husky_a200_observer_images/teleop_danger.png"
      width="800"
    />
  </figure>
</center>
...
<center>
  <figure>
    <img
      src="/img/robot_images/husky_a200_observer_images/gps_danger.png"
      width="800"
    />
  </figure>
</center>
...
[Autonomous Mode](/docs_outdoornav_user_manual/web_user_interface/ui_overview#autonomy-features),
including details on Autonomous Docking.
...
<center>
  <figure>
    <img
      src="/img/robot_images/husky_a200_observer_images/filezilla_connection_details.png"
      width="400"
    />
...
<center>
  <figure>
    <img
      src="/img/robot_images/husky_a200_observer_images/filezilla_full_view.png"
      width="800"
    />
...
The Husky A200 Observer is equipped with a pan-tilt-zoom (PTZ) camera that is capable of
...
inside Husky A200 Observer until downloaded and deleted by the operator. When the download/delete function is performed
...
### Husky A200 Observer Network Components
...
| Networking Gateway, Microhard, Base Station (optional) | 192.168.131.50                   | **user:** admin<br/>**password:** clearpath |
| Networking Gateway, Microhard, robot                   | 192.168.131.51                   | **user:** admin<br/>**password:** clearpath |
...
Each of the sensors on Husky A200 Observer has a variety of settings, which have
...
The Husky A200 Observer is equipped with an [Axis Q62](https://www.axis.com/products/axis-q62-series) series PTZ camera, with
...
<center>
  <figure>
    <img
      src="/img/robot_images/husky_a200_observer_images/axis_q62_login.png"
      width="300"
    />
...
<center>
  <figure>
    <img
      src="/img/robot_images/husky_a200_observer_images/axis_q62_settings_ptz.png"
      width="800"
    />
...
<center>
  <figure>
    <img
      src="/img/robot_images/husky_a200_observer_images/axis_q62_limits_off.png"
      width="300"
    />
...
<center>
  <figure>
    <img
      src="/img/robot_images/husky_a200_observer_images/axis_q62_set_left_limit.png"
      width="e00"
    />
...
<center>
  <figure>
    <img
      src="/img/robot_images/husky_a200_observer_images/axis_q62_set_right_limit.png"
      width="300"
    />
