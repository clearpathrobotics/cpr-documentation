---
title: Husky A200 Observer Integration
...
To attach custom hardware to Husky A200 Observer, you will have to take care of mechanical mounting, electrical
supply, and software integration. This guide aims to equip you with respect to these challenges.

## Mechanical Mounting

Husky A200 Observer has two PACS&trade;-compatible mount points on the top of the robot, one at the front
...
On the Husky A200 Observer lid, there are three data interfaces that can be used for system maintenance
and debugging:
...
On the Husky A200 Observer lid, there is an Icotek KEL-FG-ER-E3 connector with three cable glands that will allow the user to
create and route power cables from custom payloads on the lid to power sources inside the Husky A200 Observer
...
Inside the Husky A200 Observer, power is available from terminal blocks as outlined in the table below.
...
<center>
  <figure>
    <img
      src="/img/robot_images/husky_a200_observer_images/power_distribution_terminal_blocks.png"
      width="400"
    />
