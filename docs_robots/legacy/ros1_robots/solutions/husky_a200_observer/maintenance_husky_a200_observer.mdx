---
title: Husky A200 Observer Maintenance
...
- Use the OutdoorNav UI to dock the robot autonomously. Please consult
  [Autonomous Missions](user_manual_husky_a200_observer#autonomous-missions) for further details.
  This method requires that the [base station has been surveyed](user_manual_husky_a200_observer#survey-base-station),
  the [Datum has been set to the coordinates of the test site](user_manual_husky_a200_observer#set-datum),
  and that the [dock location has been set](user_manual_husky_a200_observer#set-dock-location).
...
The fans between the Husky A200 Observer wheels are intake fans with filters.
...
1. Remove the four screws holding the fan cover panel in place as shown in the image below.
    <center>
      <figure>
        <img
          src="/img/robot_images/husky_a200_observer_images/base_screws_for_fan_maintenance.png"
          width="400"
        />
...
The top fans on the front side of Husky A200 Observer are intake fans with filters.
These filters require periodic maintenance to clean or replace the filters.
In very dusty off-road environments, these filters should be inspected
...
1. Remove the four screws holding the fan cover screen in place as shown in the image below.
    <center>
      <figure>
        <img
          src="/img/robot_images/husky_a200_observer_images/cabinet_screws_for_fan_maintenance.png"
          width="400"
        />
...
1. Open the top lid of Husky A200 Observer and pull out the fan assembly from the inside.
...
The top fans on the rear side of Husky A200 Observer are exhaust fans and, as such,
...
noted above, Husky A200 Observer also includes OutdoorNav software, which can be
upgraded.
Contact [Support](#support) if you need more details on updating Husky A200 Observer software.
...
### Storing Husky A200 Observer for Extended Periods
...
### Preparing Husky A200 Observer for Shipping
...
[System Specifications](user_manual_husky_a200_observer.mdx#system-specifications).
...
### Disposing of Husky A200 Observer

<center>
  <img
    src="/img/robot_images/husky_a200_observer_images/disposal_warning.png"
    width="800"
  />
</center>
