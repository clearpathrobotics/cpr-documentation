...
- Use the OutdoorNav UI to dock the robot autonomously. Please consult
  [Autonomous Missions](user_manual_husky_observer#autonomous-missions) for further details.
  This method requires that the [base station has been surveyed](user_manual_husky_observer#survey-base-station),
  the [Datum has been set to the coordinates of the test site](user_manual_husky_observer#set-datum),
  and that the [dock location has been set](user_manual_husky_observer#set-dock-location).
...
[System Specifications](user_manual_husky_observer.mdx#system-specifications).
