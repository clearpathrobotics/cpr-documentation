...
Refer to [Husky A200 Observer Integration](integration_husky_observer.mdx) for details on how to integrate your own payload or how to integrate a payload kit from Clearpath Robotics.
...
to the main computer. See [Husky A200 Observer Integration](integration_husky_observer.mdx)
for further details.
