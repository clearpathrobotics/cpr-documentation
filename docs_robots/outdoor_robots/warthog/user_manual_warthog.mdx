...
| Minimum Turn-In-Place Angular Velocity | 0.2 rad/s (Measured on asphalt with standard tires. Performance varies with surface, tires, and payload configuration) |
...
| Capacity                        | 105 Ah at 48 V, expandable to 118 Ah at 51.2V with LiFEPO<sub>4</sub> option               |
