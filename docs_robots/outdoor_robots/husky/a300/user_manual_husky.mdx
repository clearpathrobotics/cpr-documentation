...
The Dock will continuously top up the batteries, so you can leave the robot near the Dock indefinately.
...
This functions the same as the Wireless Chargin kit, but we also add sensors that allow the robot to see the Dock.
The Autonomous Wireless Charger is included with our [Husky A300 Observer](../../../solutions/husky_a300_observer/user_manual_husky_a300_observer).
