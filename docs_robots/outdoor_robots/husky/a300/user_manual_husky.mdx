...
Robots that include our [OutdoorNav](/docs_outdoornav_user_manual/web_user_interface/ui_overview) autonomy can be configured with a Autonomous Wireless Charger.
