...
<center>
  <figure>
    <img
      ...
      width="600"
    />
    <figcaption>Husky A300 Rear Charge Port Door, Closed</figcaption>
  </figure>
  <figure>
    <img
      ...
      width="600"
    />
    <figcaption>Husky A300 Rear Charge Port Door, Open</figcaption>
  </figure>
</center>
...
connection. See also [Robot Network Connection](#network-connection).
...
1. Open the Rear Charge Port Door, set the Battery Breaker to the "ON" position, and close the Rear Charge Port Door.
...
1. Wait until all lights on Husky have turned off (up to 10 seconds). This indicates that all electronics have
   powered off.
1. Open the Rear Charge Port Door, set the Battery Breaker to the "OFF" position, and close the Rear Charge Port Door.
1. Clamp the Lock-Out Tag-Out lock to prevent the Rear Charge Port Door from being opened.
...
1.  Open the Rear Charge Port Door to expose the Battery Charger Port.
...
1.  Close the Rear Charge Port Door.
