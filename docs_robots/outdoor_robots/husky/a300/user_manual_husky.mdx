...
- Familiarize yourself with the [Technical Specifications](#technical-specifications).
...
When no payload is present, refer to the [Technical Specifications](#technical-specifications) for
...
See [Technical Specifications](#technical-specifications) for the weight of Husky and its maximum payload.
...
temperature range outlined in [Technical Specifications](#technical-specifications).
