...
| Charge Time, Standard Charger _(North America)_ | 4 hours (2-battery) or 8 hours (4-battery) or 12 hours (6-battery)            |
| Charge Time, Standard Charger _(Europe)_ | 5 hours (2-battery) or 10 hours (4-battery) or 15 hours (6-battery)            |
| Charge Time, Upgraded 650 W Charger | 1.75 hours (2-battery) or 3.5 hours (4-battery) or 5.25 hours (6-battery)            |
| Charge Time, Upgraded 650 W Charger | 2 hours (4-battery) or 3 hours (6-battery)            |
...
- Standard Manual Charger, North America (Henryuan Model PSY27710000): 277 W, indoor use only
- Standard Manual Charger, Europe (Mean Well Model NPB-240-24TB): 222 W, indoor use only
- High Power Manual Chargers
...
#### Wireless Charging _(Add-on Kit)_

When this kit is installed, it includes two main parts:

- A _Mobile Coil_ mounted on the right side of the Husky A300.
- A _Docking Station_, separate from the robot, which includes the Stationary Electronics and Stationary Coil. 
...
Robots that include our [OutdoorNav](/docs_outdoornav_user_manual/web_user_interface/ui_overview) autonomy can be configured with an Autonomous Wireless Charger.
This functions the same as the Wireless Charging kit, but we also add sensors that allow the robot to see the Dock.
The Autonomous Wireless Charger is included with our [Husky A300 Observer](../../../solutions/husky_a300_observer).
