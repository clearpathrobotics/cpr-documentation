...
If you are unsure whether this is the case, feel free to contact [support@clearpathrobotics.com](mailto:support@clearpathrobotics.com) with a rosbag of your system.
...
The `/twist_mux` topic controls the priority of `/cmd_vel` messages.
