...
#### Observer Backpack
The Observer backpack is a large enclosure with multiple mounting locations for additional sensors. It is used by the [Husky Observer](/docs/robots/solutions/husky_observer/).
