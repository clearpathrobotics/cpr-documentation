...
5. [**sensors**](#sensors) that are an inventory of Clearpath supported sensors.
...
#### Sample
On the **J100 Jackal**, bumpers are the only decorations that can be modified.

In this sample, we swapped the front bumper for the Wibotic Charging Kit receiver bumper.
<details><summary>Sample J100 Platform Section</summary>
<p>
...
### Sample
In this sample, we use a cylinder primitive as a mounting tower for the Velodyne Lidar (see the [sensors](#sensors) section).

<details><summary>Sample J100 Accessories Section</summary>
<p>
...
## Mounts
### Sample
<details><summary>Sample J100 Mounts Section</summary>
<p>
