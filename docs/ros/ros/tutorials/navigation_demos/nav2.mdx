...
We will be using a J100 with a Hokuyo UST10 attached to the front of the robot. The `robot.yaml` is available here. <---TODO
...
<center>
  <figure>
    <img
      src="/img/software_images/ros2/tutorials/navigation/nav2.gif"
      width="900"
    />
