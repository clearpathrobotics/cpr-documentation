...
:::note
If your robot comes with a Logitech F710 controller, it will be paired already.
Simply turn on the robot, plug the USB dongle into one of the robot’s USB ports, and turn on the controller.
:::

To re-pair the Logitech F710 controller or pair a new Logitech F710 controller,
plug the controller’s USB dongle into the robot’s computer and turn on the controller. The controller automatically pairs.
