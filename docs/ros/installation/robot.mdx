...
Once the Clearpath package server is set up, follow the [Clearpath Computer Setup](../networking/computer_setup.mdx) instructions to configure the network interfaces.
