...
| :------------------------- | :------------------------------------------------------: | :---------------- |
| Kinova Gen3 lite Bundle    | [022586](/assets/pdf/clearpath_robotics_015822-TDS1.pdf) | 00864-01          |
...
The mating connector _Lumberg 0317 08_ is available as Clearpath Robotics item 024774

:::

<figure>
  <img
    src="/img/manipulator_images/manipulator_kinova_gen3_lite_3.png"
    width="150"
  />
  <figcaption>Mating connector Lumberg 0317 08 rear view</figcaption>
</figure>
...
<Tabs groupId="ros_versions">
  ...
  >
    <p>
      Refer to Clearpath's GitHub repository for Husky Manipulation,{" "}
      <a href="https://github.com/husky/husky_manipulation">https://github.com/husky/husky_manipulation</a>.
    </p>
  </TabItem>
  <TabItem
    value="dingo"
  ...
  >
    <p>
      Refer to Clearpath's GitHub repository for Dingo Manipulation,{" "}
      <a href="https://github.com/dingo-cpr/dingo_manipulation">https://github.com/dingo-cpr/dingo_manipulation</a>.
    </p>
  </TabItem>
</Tabs>
