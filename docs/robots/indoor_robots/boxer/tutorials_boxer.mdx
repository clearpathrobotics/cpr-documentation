...
The visualization shows the depth data from the Base Unit's RealSense camera (the rainbow-coloured points) as well as the data from the front and rear lidars.
