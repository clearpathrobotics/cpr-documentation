...
| Operating Time (Dingo 1.5) | 2 hours (1X SLA), 4 hours (1X LiFEPO<sub>4</sub>)           | 2-6 hours (1-3X SLA), 3.5-11 hours (1-3X LiFEPO<sub>4</sub>) |
| Battery Chemistry          | Sealed Lead-Acid or Lithium (Dingo 1.0) / LiFEPO<sub>4</sub> (Dingo 1.5) | Same as Dingo-D                                   |
| Charge Time                | 3.3 hours (1X SLA) or 3.0 hours (1X LiFEPO<sub>4</sub>)     | 3.3-10 hours (1-3X SLA) or 3-9 hours (1-3X LiFEPO<sub>4</sub>) |
...
<!--- TODO: Adjust operating time + charge time once determined --->
