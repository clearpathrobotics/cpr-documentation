...
simulated world, rviz shows the robot's *perception* of its world, whether real or simulated. So while
...
The second, more sophisticated way to modify the URDF is to create a *new* package for your own robot, and build your own
...
Refer to the [Jetson](/docs/computers/jetson) page for details on installing a Jetson in Dingo.
