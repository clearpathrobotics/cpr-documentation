...
|                                  Icon                                   | Description                                                                                                                                                                                                                                                                                                                                                                                                             |
| :---------------------------------------------------------------------: | :---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
|  <img src="/img/robot_images/dingo_images/icon-motor.png" width="50"/>  | **Motor Stop button**: LED is solid green when Dingo is able to drive and flashing green when the Dingo's motors are disengaged; pressing button toggles the motors between engaged and disengaged mode (further details in [Motor Stop Buttons](#dingo-stop-buttons))                                                                                                                                                  |
...
|  <img src="/img/robot_images/dingo_images/icon-wifi.png" width="50"/>   | **Wifi indicator**: LED is solid green when wifi is connected and LED is off otherwise                                                                                                                                                                                                                                                                                                                                  |
...
To get Dingo connected to your local wifi network, you must first access the Onboard Computer using
