...
A standard Dingo is delivered with an 80 mm square mounting pattern of M5 threaded holes on Dingo's trough cover as shown in [Exterior Features](#dingo-exterior-features), which can be used for attaching external payloads.
