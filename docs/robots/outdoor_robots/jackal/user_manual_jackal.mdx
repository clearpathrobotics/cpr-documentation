...
If not, or to set up your own Onboard Computer, see the [Jackal Tutorials](/docs/robots/outdoor_robots/jackal/tutorials_jackal#jackal-software-setup).
...
ethernet cable. See the [Jackal Tutorials](/docs/robots/outdoor_robots/jackal/tutorials_jackal#jackal-networking) for details
...
the [Jackal Tutorials](/docs/robots/outdoor_robots/jackal/tutorials_jackal#pairing-the-controller).
