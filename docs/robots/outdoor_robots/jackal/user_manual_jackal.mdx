...
documention portal, under the [Computers](/docs/add-ons/computers), [Sensors](/docs/add-ons/sensors), [Manipulators](/docs/add-ons/manipulators),
and [Accessories](/docs/add-ons/accessories) sections. In addition, refer to [Jackal Integration](/docs/robots/outdoor_robots/jackal/integration_jackal) for
