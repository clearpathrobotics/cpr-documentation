...
The top plates for the Warthog include M5×0.8 threaded holes that match the Clearpath PACS&trade; standard.

:::note

These top plates require [extrusion rails](./kits_warthog/extrusion_rails_warthog) to be mounted on the Warthog.

:::

:::note

You can install an [extrusion cross-bar](./kits_warthog/extrusion_crossbar_warthog) under the top plates to add stiffness.
