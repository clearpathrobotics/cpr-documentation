...
import ComponentPacsFasteners from "/docs/components/pacs_fasteners.mdx";
import ComponentPacsMechanical from "/docs/components/pacs_mechanical.mdx";
import ComponentCommonSoftwareIntegration from "/docs/components/common_software_integration.mdx";
import ComponentTableHuskyOne from "/docs/components/table_husky_1.mdx";
...
- [Wireless Stop receivers](../../../add-ons/add-ons/wireless_stop_system)
