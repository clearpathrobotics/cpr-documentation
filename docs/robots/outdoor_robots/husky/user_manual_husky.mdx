...
See the [Husky Tutorials](/docs/robots/outdoor_robots/husky/tutorials_husky#husky-networking) for details.
...
[Husky Tutorials](/docs/robots/outdoor_robots/husky/tutorials_husky#pairing-the-controller).
