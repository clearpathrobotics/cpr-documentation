...
**Do not operate the robot near people, ladders, vertical drops, or stationary racks.**

The standard Husky A300 robot is not equipped with an obstacle avoidance system.
This can present a crush or impact hazard.
...
**Keep hands and other objects clear of the Husky A300 at all times.**

Objects can be pinched between the Husky A300 and other fixtures in the environment or
between the Husky A300 wheels and the Husky A300 frame.
...
**Never push Husky A300 when moving it manually.**
...
**Never be manual bypass Husky's A300 drive wheels when on a ramp or slope.**
 
This may lead to robots navigating erratically and losing control. If stopped on a slope
(with Emergency Stop engaged), Husky A300 may begin to roll and may present a hazard.
...
The image below illustrates the stability cone for Husky A300 (2-battery configuration).
It shows the location in which the centre of mass of a 100 kg payload must occur to
avoid tipping while being able to operate at inclines of 30 degrees, side slopes
of up to 30 degrees, and accelerations up to 4 m/s². A safety factor should
be applied so that the centre of mass is well inside the defined stability cone,
especially when operating on uneven surfaces on inclines or side slopes
near the defined limit. 
...
<center>
  <figure>
    <img
      ...
      width="600"
    />
    <figcaption>Husky A300 Stability Cone (2-battery configuration), specifications in mm</figcaption>
  </figure>
</center>
