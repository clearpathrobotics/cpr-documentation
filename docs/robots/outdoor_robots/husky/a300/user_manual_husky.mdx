...
| :------ | :--------- | :------------ | :------------------------ | :------------------------ | :---- |
| Motor [1-4] Temperature | /platform/motors/status | drivers[0-3].motor_temperature | 0 | 100 | Does not affect fan speed |
...
| Fan Intake Temperature | /platform/mcu/status/temperature | temperatures[CC01_FAN[1-4]] | -20 | 50 | |
