...
- environments free of grades greater than 27%.
...
<center>
  ...
  <figure>
    <img
      src="/img/robot_images/husky_a300_images/husky_a300_wireless_emergency_stop_override.png"
      width="500"
    />
    <figcaption>Wireless Emergency Stop override</figcaption>
  </figure>
</center>
...
its critical thermal limits, system throttling may occur.

| Sensor  | ROS Topic  | Message Field | Lower Critical Limit (°C) | Upper Critical Limit (°C) | Notes |
| :------ | :--------- | :------------ | :------------------------ | :------------------------ | :---- |
| Motor [1-4] Temperature | /platform/motors/status | drivers[0-3].motor_temperature | -10 | 100 | Does not affect fan speed |
| Motor Driver [1-4] MCU Temperature | /platform/motors/status | drivers[0-3].mcu_temperature | -20 | 80 | |
| Motor Driver [1-4] PCB Temperature | /platform/motors/status | drivers[0-3].pcb_temperature | -20 | 80 | |
| Battery [1-6] Temperature | /bms/battery_state_[1-6] | temperature | -20 | 60 | Charging must occur above 0°C |
| MCU Temperature | /platform/mcu/status/temperature | temperatures[CC01_MCU] | -20 | 80 | |
| Fan Controller Temperature | /platform/mcu/status/temperature | temperatures[CC01_FAN[1-4]] | -20 | 80 | |
| 5V Inductor Temperature | /platform/mcu/status/temperature | temperatures[5V_INDUCTOR] | -20 | 80 | |
| Main Ground Lug Temperature | /platform/mcu/status/temperature | temperatures[MAIN_GND_LUG] | -20 | 80 | |
| 24V DC/DC Temperature | /platform/mcu/status/temperature | temperatures[24V_DCDC] | -20 | 80 | |
| 12V DC/DC Temperature | /platform/mcu/status/temperature | temperatures[12V_DCDC] | -20 | 80 | |
...
the `/a300_0002/platform/cmd_lights` topic.
...
<center>
  <figure>
    <img
      ...
      width="600"
    />
    <figcaption>Husky A300 Wireless Emergency Stop Bypass (1 = active, 2 = bypassed)</figcaption>
  </figure>
</center>
...
Tim Davis, Development Test Manager<br/>
tadavis@ra.rockwell.com<br/>
(262) 512-8257 x58250
