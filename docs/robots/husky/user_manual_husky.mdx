...
Husky is built around a computer running Ubuntu (Intel-based computer or Jetson developer kit), paired
with a 32-bit MCU. The MCU handles power supply monitoring and motor control. The communication channel
between the MCU and computer is a serial connection.
