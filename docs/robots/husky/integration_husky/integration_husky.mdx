...
If you are wanting to attach custom hardware to Husky, you will have to take care of mechanical mounting, electrical
...
- [Top Plate](/docs/robots/husky/integration_husky/kits/top_plate_husky)
- [Weatherproofing Cover](/docs/robots/husky/integration_husky/kits/user_bay_cover_husky)
- [Riser, Full](/docs/robots/husky/integration_husky/kits/riser_full_husky)
- [Riser, Partial](/docs/robots/husky/integration_husky/kits/riser_partial_husky)
- [Riser, Stiffener](/docs/robots/husky/integration_husky/kits/riser_stiffener_husky)
- [Electronics Rack](/docs/robots/husky/integration_husky/kits/electronics_rack_husky)
...
please visit the
[DigiKey WM23702-ND Product Page](https://www.digikey.ca/en/products/detail/molex/0039012065/930272?s=N4IgTCBcDaIOoFkwGYDsAGMBaAcgERAF0BfIA).
...
Clearpath Robotics offers an upgrade kit to add an external e-stop. Contact [Support](#support) for details.

#### MCU Debug LEDs

The Husky MCU PCBA comes equipped with LEDs for debugging. They work as follows:

- **D16: HEARTBEAT**: toggles every 500ms when the main firmware loop on the MCU is running
- **D7: VBAT 20A**: illuminated if the VBAT 20A fuse is working
- **D8: VBAT 5A**: illuminated if the VBAT 5A fuse is working
- **D12: 12V 7.5A**: illuminated if the 12V 7.5A fuse is working
- **D10: 24V 3A**: illuminated if the 24V 3A fuse is working

:::note
On older revisions of the Husky MCU PCBA, the labels are different, but the functionality is similar:
- D5: HEARTBEAT
- D2: VBAT 5A fuse working
- D3: 12V 5A fuse working
- D4: 5V 5A fuse working
:::
...
Husky, which will include simulation, visualization, and driver support. Refer to the following
for more details:
