...
:::caution
TODO: Need to check if this needs to be updated for new MCU PCBAs
:::
...
Husky, which will include simulation, visualization, and driver support. However, we will happily
