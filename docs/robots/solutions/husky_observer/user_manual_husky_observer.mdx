...
color and low-light capabilities, defogger, and lens wiper.
...
[http://192.168.131.10](http://192.168.131.10). Log into the Axis configuration website using the username `root` and
the password `clearpath`.
...
<center>
  <figure>
    <img
      ...
      width="600"
    />
    <figcaption>Axis Q62 login screen (TODO: new image)</figcaption>
  </figure>
</center>
...
<center>
  <figure>
    <img
      ...
      width="600"
    />
    <figcaption>Axis Q62 PTZ settings (TODO: new image)</figcaption>
  </figure>
</center>
...
<center>
  <figure>
    <img
      ...
      width="600"
    />
    <figcaption>Disabling the Axis Q62 pan limits (TODO: new image)</figcaption>
  </figure>
</center>

Move the camera to a pan of -179 degrees. Then click on the left pan limit button to set the left limit to -179 degrees.
...
<center>
  <figure>
    <img
      ...
      width="600"
    />
    <figcaption>Setting the left pan limit to -179 degrees (TODO: new image)</figcaption>
  </figure>
</center>

Then move the camera to a pan of 180 degrees.  Click on the right pan limit button to set the right pan limit to 180
degrees.
...
<center>
  <figure>
    <img
      ...
      width="600"
    />
    <figcaption>Setting the right pan limit to 180 degrees (TODO: new image)</figcaption>
  </figure>
</center>

Click the Done button to apply the new limits.

<center>
  <figure>
    <img
      src="/img/robot_images/husky_observer_images/axis_q62_done.png"
      width="600"
    />
    <figcaption>Click Done to apply the pan limits (TODO: new image)</figcaption>
  </figure>
</center>
