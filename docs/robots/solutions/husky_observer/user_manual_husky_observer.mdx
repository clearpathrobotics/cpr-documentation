...
your robot. The SSID of the network will be ``HITT04BaseRadio''. The
password to connect to this network is ``\textbf{clearpath}''.
...
[User Manual](/docs/robots/solutions/husky_observer/husky_observer_user_manual#exterior-features),
...
[User Manual](/docs/robots/solutions/husky_observer/husky_observer_user_manual#networking-configuration) for a full list).
...
[OutdoorNav User Manual](https://docs.clearpathrobotics.com/docs_outdoornav_user_manual/getting_started/system_setup#set-datum)
...
[OutdoorNav User Manual](https://docs.clearpathrobotics.com/docs_outdoornav_user_manual/getting_started/system_setup#set-dock-location)
...
\begin{itemize}
  \item \textbf{WiFi SSID:} HITT04 Base Station
  \item \textbf{WiFi password:} clearpath
  \item \textbf{Available IP range:} 192.168.131.200 to 192.168.131.254
  \item \textbf{Subnet:} 255.255.255.0
  \item \textbf{Gateway:} 192.168.131.50
\end{itemize}
...
See [Maintenance](/docs/robots/solutions/husky_observer/husky_observer_maintenance#software_maintenance) for details on keeping Husky Observer software up to date.