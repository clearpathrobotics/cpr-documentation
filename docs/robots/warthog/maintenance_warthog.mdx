...
You need to use an external computer to update Warthog's MCU firmware.  You cannot use Warthog's internal computer, as installing the
firmware requires power-cycling the MCU.  Warthog's MCU controls the power supply to the internal computer.  These instructions
