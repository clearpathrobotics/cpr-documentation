...
A standard Wathod includes thru holes on the sides of the battery compartment.
...
- [Extrusion Rails](/docs/robots/warthog/integration_warthog/kits_warthog/extrusion_rails_warthog)
- [Extrusion Cross-Bar](/docs/robots/warthog/integration_warthog/kits_warthog/extrusion_crossbar_warthog)
- [Top Plate](/docs/robots/warthog/integration_warthog/kits_warthog/top_plate_warthog)
