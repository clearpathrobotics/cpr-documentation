...
reinstall the operating system by following the steps outlined [Boxer Backpack PC Software Setup](/docs/robots/boxer/tutorials_boxer#boxer-software-setup).
