...
reinstall the operating system by following the steps outlined [Boxer Backpack Computer Software Setup](/docs/robots/boxer/tutorials_boxer#boxer-software-setup).
