...
<center>
  <img
    src="/img/robot_images/husky_images/robot_boxer_2.png"
    width="400"
  />
</center>
...
<center>
  <img
    src="/img/robot_images/husky_images/robot_boxer_3.png"
    width="400"
  />
</center>
...
<center>
  <img
    src="/img/robot_images/husky_images/robot_boxer_4.png"
    width="400"
  />
</center>
...
<center>
  <img
    src="/img/robot_images/husky_images/robot_boxer_5.png"
    width="400"
  />
</center>
...
1.  Turn the 2 circuit breakers to the on position.
    ...
    <center>
      <img
        src="/img/robot_images/husky_images/robot_boxer_6.jpg"
        width="400"
      />
    </center>
2.  Press the Power Button.
    <center>
      <img
        src="/img/robot_images/husky_images/robot_boxer_7.png"
        width="400"
      />
    </center>
...
2.  Connect a network cable from the port on your laptop to the network port on the rear of the Base Unit.
    <center>
      <img
        src="/img/robot_images/husky_images/robot_boxer_8.png"
        width="400"
      />
    </center>
...
4.  Enter the required information to connect to your network.
    ...
    <center>
      <img
        src="/img/robot_images/husky_images/robot_boxer_9.png"
        width="600"
      />
    </center>
    <center>
      <img
        src="/img/robot_images/husky_images/robot_boxer_10.png"
        width="600"
      />
    </center>
...
8.  Using the hostname or static IP set in the Wi-Fi setup above, load the _OTTO App_ user interface by opening a web-browser, and going to the address _http://hostname:5000_.
    ...
    <center>
      <img
        src="/img/robot_images/husky_images/robot_boxer_11.png"
        width="600"
      />
    </center>
9.  Adjust the volume to an appropriate level for your facility by selecting the _Vehicle_ option from the top-left menu and adjusting the volume as appropriate.
    <center>
      <img
        src="/img/robot_images/husky_images/robot_boxer_12.png"
        width="600"
      />
    </center>
...
2.  Ensure that the E-stop is released by pulling out the red button at the rear of the unit, and then pressing the blue Reset button.
    <center>
      <img
        src="/img/robot_images/husky_images/robot_boxer_13.jpg"
        width="200"
      />
    </center>
    <center>
      <img
        src="/img/robot_images/husky_images/robot_boxer_14.png"
        width="200"
      />
    </center>
...
2.  The first time after power-up, it is necessary to take the system out of neutral by clicking on the joystick icon at the bottom right of the interface.
    <center>
      <img
        src="/img/robot_images/husky_images/robot_boxer_15.png"
        width="600"
      />
    </center>
3.  Ensure that the system is in manual mode and use the _thumbstick_ at the bottom right of the interface to drive the robot in the desired direction.
    ...
    <center>
      <img
        src="/img/robot_images/husky_images/robot_boxer_16.png"
        width="600"
      />
    </center>{" "}
...
4.  For full speed mode, hold the R1 trigger.
    ...
    <center>
      <img
        src="/img/robot_images/husky_images/robot_boxer_17.png"
        width="600"
      />
    </center>{" "}
...
<center>
  <img
    src="/img/robot_images/husky_images/robot_boxer_18.png"
    width="600"
  />
</center>{" "}
...
<center>
  <img
    src="/img/robot_images/husky_images/robot_boxer_19.png"
    width="600"
  />
</center>{" "}
