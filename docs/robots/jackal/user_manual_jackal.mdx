...
with a 32-bit MCU. The MCU handles IO, power supply monitoring and motor control, as well as supplying
...
and [Accessories](/docs/accessories) sections. In addition, refer to [Jackal Integration](/docs/robots/jackal/integration_jackal) for
...
[Jackal Integration](/docs/robots/jackal/integration_jackal#jackal-payload-electrical-integration).
...
| Battery Chemistry     | Lithium Ion, 270 Wh                                         |
...
If not, or to set up your own Onboard Computer, see the [Jackal Tutorials](/docs/robots/jackal/tutorials_jackal#jackal-software-setup).
...
ethernet cable. See the [Jackal Tutorials](/docs/robots/jackal/tutorials_jackal#jackal-networking) for details
...
the [Jackal Tutorials](/docs/robots/jackal/tutorials_jackal#pairing-the-controller).
