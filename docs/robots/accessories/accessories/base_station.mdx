...
We also have a GPS variant of the Base Station where we add a [Swift Navigation Duro](/docs/add-ons/sensors/gps/swift_navigation_duro) to the system, connecting it to the Access Point with a network cable.
