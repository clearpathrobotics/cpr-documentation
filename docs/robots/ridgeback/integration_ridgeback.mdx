...
| Inverter Power               | Anderson 1327G8 (blue) + 1327G6-BK (black)                               | Anderson 1327G8 (blue) + 1327G6-BK (black)         | Anderson 262G2-LPBK (AWG 16-20) or 261G3-LPBK (AWG 10-14)    | Anderson 1309G8  |
...
- Regulated 12 V power (5 A max), shared across the User Power ports (5 A max per port)
- Regulated 5 V power (5 A max), shared across the User Power ports (5 A max per port).
...
- 1-2: to external motion-stop breakout: press and release external button (3.3 V) to engage motion-stop; press and release
