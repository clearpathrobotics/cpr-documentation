...
Based on the Ridgeback configuration, either Ridgeback-D or Ridgeback-O, this script will know to check for good CAN packets from 2 or 4 encoders, respectively.
