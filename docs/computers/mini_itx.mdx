...
We configure the BIOS on our robot's computers to boot automatically when they receive power.
...
3.  Use hand tools to disassembly your robot, to get access to the computer.
