...
| TRENDnet, 5 port, 12 - 56 VDC           |  021041  |
| TRENDnet, 5 port, 12 - 56 VDC, PACS kit |  027638  |
| TRENDnet, 8 port, 12 - 56 VDC           |  025332  |
...
| :-: | :------------------------------------------------------ | :------------------------------------------------------: | :------: |
|  1  | Kit, Attachment—80 X 80, DIN Rail                       |           [027881](/docs/accessories/din_rail)           |    1     |
|  2  | Network Switch, Ethernet, RJ45—TRENDnet, 5 Port Gigabit | [025332](/assets/pdf/clearpath_robotics_021044-TDS1.pdf) |    1     |
|  3  | Spacer, DIN rail, Locking—35 X 7.5 X 10                 |                          023649                          |    2     |
