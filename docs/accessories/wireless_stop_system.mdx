...
| :-: | :--------------------------------------------------------- | :-------------------------------------------------: | :------: |
|  1  | Plate—80 X 80, Attachment Interface, Large                 | [026964](/assets/pdf/clearpath_robotics_026964.pdf) |    1     |
|  2  | Bundle, Wireless Safety Controller—Kartech                 |                       014663                        |    1     |
|  3  | Screw, Cap, Round Head—M4×0.7 X 12, Stainless Steel        |                       023310                        |    2     |
|  4  | Nut, Hex, Lock, Polymer Insert—M4×0.7 X 5, Stainless Steel |                       019899                        |    2     |
...
4.  Add a connector to the cable included in the FOR bundle (ID 2).
    ...
    Refer to [015584-TDS2](clearpath_robotics_015584-TDS2.pdf) for full details of the FORT component, including pinout.
