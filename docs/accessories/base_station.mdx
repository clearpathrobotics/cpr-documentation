...
- A [Microhard Access Point](/docs/accessories/network_access_point/#ap_microhard_px2_enc) and antenna, to create a Wi-Fi network
...
Refer to the [Network IP Addresses page](/docs/tools/network_ip_addresses) for the commonly used IPs of devices like Microhards and Swift Navigation Duros.
