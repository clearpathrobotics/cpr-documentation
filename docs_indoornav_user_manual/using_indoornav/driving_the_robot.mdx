...
1.  Create a map. See [Making a Map](/docs_indoornav_user_manual/using_indoornav/maps#making-a-map) for
    details.
...
1.  Create a map. See [Making a Map](/docs_indoornav_user_manual/using_indoornav/maps#making-a-map) for
    details.
2.  Add Endpoints to the map. See [Adding Endpoints](/docs_indoornav_user_manual/using_indoornav/maps#adding-endpoints) for details.
