...
5.  From the upper toolbar, select **New Map**. The existing map (if
    ...
    <center>
      <figure>
        <img src="/img/indoornav_images/IndoorNav/mapMainMenu.png" width="150px" />
      </figure>
    </center>
...
6.  Select **REC** to begin recording the map. Select **Pause** at any
    ...
    <center>
      <figure>
        <img src="/img/indoornav_images/IndoorNav/mapRecord.png" width="100px" />
      </figure>
    </center>
...
<center>
  <figure>
    <img src="/img/indoornav_images/IndoorNav/mapTools.png" width="250px" />
  </figure>
</center>
...
3.  Select the desired location on the map where the endpoint will be
    ...
    <center>
      <figure>
        <img src="/img/indoornav_images/IndoorNav/endpointTools.png" width="200px" />
      </figure>
    </center>
...
<center>
  <figure>
    <img src="/img/indoornav_images/IndoorNav/zoneTools.png" width="200px" />
  </figure>
</center>
...
<center>
  <figure>
    <img src="/img/indoornav_images/IndoorNav/zoneTypes.png" width="200px" />
  </figure>
</center>
...
target. Refer to [Support](/docs_indooornav_user_manual/support) for
...
1.  **Mapping**: Position the dock in its intended position, then
    ...
    <center>
      <figure>
        <img src="/img/indoornav_images/IndoorNav/dock_mapping.png" width="400px" />
      </figure>
    </center>
...
2.  **Placing Dock on the Map**: Once the map is created, overlay the
    ...
    <center>
      <figure>
        <img src="/img/indoornav_images/IndoorNav/dock_on_map.png" width="400px" />
      </figure>
    </center>
...
3.  **Docking**: Select the "Dock Endpoint" and add it to the map so
    ...
    <center>
      <figure>
        <img src="/img/indoornav_images/IndoorNav/dock_endpoint.png" width="400px" />
      </figure>
    </center>
...
4.  **Undocking**: Add an "Undock Endpoint" at the position of the
    ...
    <center>
      <figure>
        <img src="/img/indoornav_images/IndoorNav/undock_endpoint.png" width="400px" />
      </figure>
    </center>
...
<center>
  <figure>
    <img src="/img/indoornav_images/IndoorNav/sample_workflow_with_docking.png" width="150px" />
  </figure>
</center>
