...
1. Locate the fuse to be replaced. Follow the maintenance procedures for the corresponding
   ...
   :::safety-caution
   **Treat all circuits, cables, and fuses inside the robot as potentially live.**
...
1. Slide the replacement fuse into the fuse hold and push firmly until the fuse is installed fully.
   :::note
