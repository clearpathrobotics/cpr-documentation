...
forward/backward velocity, and buttons 4 and 5 act as enable and enable-turbo respectively. On common
...
left/right translation, and Axis 2 controls the forward/backward velocity. Buttons 4 and 5 act as enable and
