...
You can download the firmware tool, and the firmware binary file from [this GitHub repository](https://github.com/clearpathrobotics/puma_motor_firmware). TODO
...
```
cd ~/Downloads/puma_motor_driver  TODO
```
