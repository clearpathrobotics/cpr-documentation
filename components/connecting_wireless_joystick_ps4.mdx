...
1.  Make sure your worksite is ready to drive the robot, and that the robot will not create hazards for people, animals, or your infrastrure.
2.  Make sure the robot's status lights show that it is ready to drive.
3.  Make sure the _Wireless Joystick is connected to the robot_images_.
