...
Your robot included a PS5 wireless joystick.
...
4.  The joystick's light bar should start pulsing blue.
    This means the joystick is attempting to connect.
5.  The joystick's light bar should eventually become solid blue, indicating that it has connected to the robot's computer.


<center>
  <figure>
    {/* TODO: replace with PS5-specific image (wireless_joystick_ps5.png) */}
    <img
      src="/img/robot_images/common_images/wireless_joystick_ps4.png"
      width="400"
    />
    <figcaption>PS5 Wireless Joystick</figcaption>
  </figure>
</center>

:::danger Failing To Connect

The _Wireless Joystick_ is not connected if its light bar does not become solid blue.
