...
Prior to installing the OutdoorNav software, ensure that you have completed the relevant [Hardware Kit Checklist](/docs_outdoornav_user_manual/integration_requirements/hardware_integration_requirements/hardware_integration_requirements). If installing on a secondary/backpack/Starter Kit computer, ensure to have also completed the:
- [Platform Computer Checklist](/docs_outdoornav_user_manual/integration_requirements/interface_control_requirements)
...
For installations of the OutdoorNav software on the platform computer (not a secondary/backpack/Starter Kit computer), run the following:
...
:::note
If you are installing the OutdoorNav software on a secondary/backpack/Starter Kit computer, you must also complete the [Platform Computer Checklist](/docs_outdoornav_user_manual/integration_requirements/platform_computer_checklist)
:::
