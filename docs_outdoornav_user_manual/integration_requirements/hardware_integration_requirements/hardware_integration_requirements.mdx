...
In addition, if a secondary/backpack/Starter Kit computer is being used, ensure that the platform computer is configured correctly by reviewing the following checklist.
