...
expected to be available in late 2022.
...
| Wireless e-Stop range limits                     | The UGV will E-Stop if the UGV is driven out of range of the Wireless Emergency Stop device.                                                                                                                                                                                                                               |
