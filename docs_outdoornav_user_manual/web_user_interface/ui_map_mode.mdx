...
navigation modules that allows the Operator(s) to define drivable paths and 
...
-   **Map** A Operator created map that goes over the aerial view and is used to define valid drivable 
    areas for a mission.
