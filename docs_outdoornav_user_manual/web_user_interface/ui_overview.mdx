...
5.  **Layers Menu:** This button opens the Layers menu which allows users to show and hide elements on the map.
    ...
    <center>
      <figure>
        <video autoplay="true" loop="true" width="800">
...
-   <img src="/img/outdoornav_images/task_dock.png" width="30px"/> <strong>Dock Robot: </strong>
...
-   <img src="/img/outdoornav_images/movePTZTask.png" width="30px"/>  <strong>Move PTZ: </strong>
...
-   <img src="/img/outdoornav_images/task_camera.png" width="30px"/>  <strong>Save Image: </strong>
    ...
    such as FileZilla or by navigating to the Files section in the hamburger menu.

    Settings: Select which camera the image will be saved from.

-   <img src="/img/outdoornav_images/task_record.png" width="30px"/>/<img src="/img/outdoornav_images/task_stopRecord.png" width="30px"/> <strong>Start/Stop Video Recording: </strong>
    ...
    using a tool such as FileZilla or by navigating to the Files section in the hamburger menu.

    Settings: Select which camera the recording will come from.

-   <img src="/img/outdoornav_images/task_audio.png" width="30px"/> <strong>Start/Stop Audio Recording:</strong>
    Will start/stop recording audio using one of the
    UGV microphone(s) to the /opt/onav/saved_files/media/... folder and can be retrieved
    using a tool such as FileZilla or by navigating to the Files section in the hamburger menu.

    Settings: Select which microphone the recording will come from.

-   <img src="/img/outdoornav_images/task_undock.png" width="30px"/> <strong>Undock UGV: </strong>
...
-   <img src="/img/outdoornav_images/task_wait.png" width="30px"/> <strong>Wait: </strong>
...
-   <img src="/img/outdoornav_images/task_inspect.png" width="30px"/> <strong>Inspect POI: </strong>
...
-   <img src="/img/outdoornav_images/task_custom.png" width="30px"/> <strong>New Custom Task: </strong>
