...
2.  **Zoom-to-Fit Button:** This button will zoom the map to where there
    ...
    set on the map.
3.  **UGV:** The blue arrow represents the UGV. Its location is its
    position in the world frame and its orientation is the heading in
    the world frame.
4.  **Base Station:** The yellow antenna icon is the last known location of
...
5.  **Dock:** If a dock is configured for the UGV it will appear on the map in
...
6.  **Datum:** The blue Waypoint marker on the map view represents the
