...
5.  **UGV + Dock:** The robot represents the UGV position, with the red arrow pointing forward.
    ...
    the world frame.
6.  **Base Station (not shown):** The yellow antenna icon is the last known location of
...
7.  **Datum (not shown):** The blue Waypoint marker on the map view represents the
