...
12. **Save Mission Button:** Save the current mission. This will store
    the the current mission to the database.

13. **Edit Mission Toggle:** This toggle allows the user to start
    creating Viapoints for the current Mission. The user will also be able to
...
19. **Feedback Bar:** The feedback bar will display information
