...
#### cpr_dock_msgs/DockInfo.msg {#msg-dock-info}
...
#### cpr_dock_msgs/DockProperties.msg {#msg-dock-properties}

```
# Message definition containing the properties for each of the docks available.

cpr_dock_msgs/DockInfo[] docks
```

#### cpr_dock_msgs/DockState.msg {#msg-dock-state}
...
#### cpr_dock_msgs/TargetTrackerState.msg {#msg-target-tracker-state}
...
#### cpr_localization_msgs/GNSSStatus.msg {#msg-gnss-status}
...
#### cpr_dock_msgs/srv/SetDockLocationById.srv {#srv-set-dock-location-by-id}
...
#### cpr_dock_msgs/srv/SetDockLocationByName.srv {#srv-set-dock-location-by-name}
...
#### cpr_dock_msgs/action/Undock.action {#action-undock}
