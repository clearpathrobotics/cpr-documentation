...
&emsp;&emsp;**Message Type:** [clearpath_navigation_msgs/CurrentGoalInfo](definitions#msg-current-goal-info)
...
&emsp;&emsp;**Description:** Remove all existig dock data from storage.
