...
&emsp;&emsp;**Action Type:** [clearpath_navigation_msgs/action/ExecuteMissionByUuidAction](definitions#action-mission-by-id)

&emsp;&emsp;**Description:** Sends a Mission uuid to execute on the robot. This also
