...
&emsp;&emsp;**Message Type:** [cpr_control_msgs/ControlSelectionState](definitions#msg-control-selection-state)
...
&emsp;&emsp;**Message Type:** [cpr_control_msgs/ControlMode](definitions#msg-control-mode)

&emsp;&emsp;**Description:** Current control mode (NEUTRAL, MANUAL, AUTONOMY).

#### /dock/feedback

&emsp;&emsp;**Message Type:** [cpr_dock_msgs/DockActionFeedback](definitions#action-dock)

&emsp;&emsp;**Description:** Feedback topic from the dock action.

#### /dock/result

&emsp;&emsp;**Message Type:** [cpr_dock_msgs/DockActionResult](definitions#action-dock)

&emsp;&emsp;**Description:** Result topic from the dock action.

#### /dock/properties

&emsp;&emsp;**Message Type:** [cpr_dock_msgs/DockProperties](definitions#msg-dock-properties)
...
&emsp;&emsp;**Message Type:** [cpr_dock_msgs/DockState](definitions#msg-dock-state)
...
&emsp;&emsp;**Message Type:** [cpr_localization_msgs/LocalizationStatus](definitions#msg-localization-status)
...
&emsp;&emsp;**Message Type:** [cpr_navigation_msgs/CurrentGoalInfo](definitions#msg-current-goal-info)
...
&emsp;&emsp;**Message Type:** [cpr_navigation_msgs/DistanceToGoal](definitions#msg-distance-to-goal)
...
&emsp;&emsp;**Message Type:** [cpr_navigation_msgs/MotionState](definitions#msg-motion-state)
...
&emsp;&emsp;**Message Type:** [cpr_navigation_msgs/OdomIntent](definitions#msg-odom-intent)
...
&emsp;&emsp;**Message Type:** [cpr_navigation_msgs/Progress](definitions#msg-navigation-progress)
...
&emsp;&emsp;**Message Type:** [cpr_navigation_msgs/ScanPoints](definitions#msg-scan-points)
...
&emsp;&emsp;**Message Type:** [cpr_navigation_msgs/NavigationState](definitions#msg-navigation-state)
...
&emsp;&emsp;**Message Type:** [cpr_navigation_msgs/TrackError](definitions#msg-track-error)
...
&emsp;&emsp;**Message Type:** [cpr_safety_msgs/WatchdogStatus](definitions#msg-safety-watchdog)
...
&emsp;&emsp;**Message Type:** [cpr_dock_msgs/TargetTrackerState](definitions#msg-target-tracker-state)

&emsp;&emsp;**Description:** The state information for target tracker used as part of docking.

#### /undock/feedback

&emsp;&emsp;**Message Type:** [cpr_dock_msgs/UndockActionFeedback](definitions#action-undock)

&emsp;&emsp;**Description:** Feedback topic from the undock action.

#### /undock/result

&emsp;&emsp;**Message Type:** [cpr_dock_msgs/UndockActionResult](definitions#action-undock)
...
&emsp;&emsp;**Message Type:** [cpr_dock_msgs/msg/DockActionGoal](definitions#action-dock)
...
&emsp;&emsp;**Message Type:** [cpr_dock_msgs/msg/UndockActionGoal](definitions#action-undock)

&emsp;&emsp;**Description:** This topic is used to send a goal to the undocking process.
The goal is empty since we always consider undocking to be a local undoking process.
...
&emsp;&emsp;**Service Type:** [cpr_control_msgs/srv/SetControlMode](definitions#srv-set-control-mode)
...
&emsp;&emsp;**Service Type:** [cpr_dock_msgs/srv/AddDock](definitions#srv-add-dock)
...
&emsp;&emsp;**Service Type:** [cpr_dock_msgs/srv/RemoveDock](definitions#srv-remove-dock)
...
&emsp;&emsp;**Service Type:** [cpr_dock_msgs/srv/SetDockLocationByID](definitions#srv-set-dock-location-by-id)
...
&emsp;&emsp;**Service Type:** [cpr_dock_msgs/srv/SetDockLocationByName](definitions#srv-set-dock-location-by-name)
...
&emsp;&emsp;**Service Type:** [cpr_localization_msgs/srv/SetDatum](definitions#srv-set-datum)
...
&emsp;&emsp;**Service Type:** [cpr_navigation_msgs/srv/SetPathSmoother](definitions#srv-set-path-smoother)
...
&emsp;&emsp;**Service Type:** [cpr_navigation_msgs/srv/SetPathShifter](definitions#srv-set-path-shifter)
...
&emsp;&emsp;**Service Type:** [cpr_navigation_msgs/srv/SetStopDistance](definitions#srv-set-stop-distance)
...
&emsp;&emsp;**Service Type:** [cpr_navigation_msgs/srv/SetDelayCompensation](definitions#srv-set-delay-compensation)
...
&emsp;&emsp;**Action Type:** [cpr_dock_msgs/action/Dock](definitions#action-dock)
...
&emsp;&emsp;**Action Type:** [cpr_localization_msgs/action/SurveyBaseStation](definitions#action-survey-base-station)

&emsp;&emsp;**Description:** Start surveying the base station, if available.

#### /mission

&emsp;&emsp;**Action Type:** [cpr_navigation_msgs/action/Mission](definitions#action-mission)
...
&emsp;&emsp;**Action Type:** [cpr_dock_msgs/action/Dock](definitions#action-undock)
