...
**Message Type:** [cpr_control_msgs/ControlSelectionState](definitions#msg-control-selection-state)
...
**Message Type:** [cpr_control_msgs/ControlMode](definitions#msg-control-mode)
...
**Message Type:** [cpr_localization_msgs/LocalizationStatus](definitions#msg-localization-status)
...
**Message Type:** [cpr_navigation_msgs/CurrentGoalInfo](definitions#msg-current-goal-info)
...
**Message Type:** [cpr_navigation_msgs/DistanceToGoal](definitions#msg-distance-to-goal)
...
**Message Type:** [cpr_navigation_msgs/MotionState](definitions#msg-motion-state)
...
**Message Type:** [cpr_navigation_msgs/OdomIntent](definitions#msg-odom-intent)
...
**Message Type:** [cpr_navigation_msgs/Progress](definitions#msg-navigation-progress)
...
**Message Type:** [cpr_navigation_msgs/ScanPoints](definitions#msg-scan-points)
...
**Message Type:** [cpr_navigation_msgs/NavigationState](definitions#msg-navigation-state)
...
**Message Type:** [cpr_navigation_msgs/TrackError](definitions#msg-track-error)
...
**Message Type:** [cpr_safety_msgs/WatchdogStatus](definitions#msg-safety-watchdog)
...
**Service Type:** [cpr_control_msgs/srv/SetControlMode](definitions#srv-set-control-mode)
...
**Service Type:** [cpr_localization_msgs/srv/SetDatum](definitions#srv-set-datum)
...
**Service Type:** [cpr_navigation_msgs/srv/SetPathSmoother](definitions#srv-set-path-smoother)
...
**Service Type:** [cpr_navigation_msgs/srv/SetPathShifter](definitions#srv-set-path-shifter)
...
**Service Type:** [cpr_navigation_msgs/srv/SetStopDistance](definitions#srv-set-stop-distance)
...
**Service Type:** [cpr_navigation_msgs/srv/SetDelayCompensation](definitions#srv-set-delay-compensation)
...
**Action Type:** [cpr_localization_msgs/action/SurveyBaseStation](definitions#action-survey-base-station)

**Description:** Start surveying the base station, if available.

#### mission

**Action Type:** [cpr_navigation_msgs/action/Mission](definitions#action-mission)
...
**Action Type:** [cpr_dock_msgs/action/Dock](definitions#action-dock)
