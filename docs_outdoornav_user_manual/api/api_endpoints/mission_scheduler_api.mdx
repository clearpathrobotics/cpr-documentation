...
it was part of. If a schedule has no missions is is automatically disabled, and cannot be re-enabled until it contains
...
### mission_scheduler/delete_everything
