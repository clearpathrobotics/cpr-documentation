...
**Message Type:** [cpr_mission_manager_msgs/msg/StorageState](definitions#storage-storagestate)
...
**Service Type:** [cpr_mission_manager_msgs/srv/CloneMission](definitions#storage-clonemission)
...
**Service Type:** [cpr_mission_manager_msgs/srv/GetTask](definitions#storage-gettask)

**Description:** Create a deep-copy of a Task.

#### mission_manager/clone_waypoint

**Service Type:** [cpr_mission_manager_msgs/srv/GetWaypoint](definitions#storage-GetWaypoint)
...
**Service Type:** [cpr_mission_manager_msgs/srv/CreateMission](definitions#storage-createmission)
...
**Service Type:** [cpr_mission_manager_msgs/srv/CreateTask](definitions#storage-createtask)

**Description:** Create a new Task.

#### mission_manager/create_waypoint

**Service Type:** [cpr_mission_manager_msgs/srv/CreateWaypoint](definitions#storage-createwaypoint)
...
**Service Type:** [cpr_mission_manager_msgs/srv/ExportData](definitions#storage-exportdata)
...
**Service Type:** [cpr_mission_manager_msgs/srv/GetEverything](definitions#storage-geteverything)
...
**Service Type:** [cpr_mission_manager_msgs/srv/GetAllMissions](definitions#storage-getallmissions)

**Description:** Get all Missions defined in the database.

#### mission_manager/get_all_tasks

**Service Type:** [cpr_mission_manager_msgs/srv/GetAllTasks](definitions#storage-getalltasks)

**Description:** Get all Tasks defined in the database.

#### mission_manager/get_all_waypoints

**Service Type:** [cpr_mission_manager_msgs/srv/GetAllWaypoints](definitions#storage-getallwaypoints)

**Description:** Get all Waypoints defined in the database.

#### mission_manager/get_mission

**Service Type:** [cpr_mission_manager_msgs/srv/GetMission](definitions#storage-getmission)
...
**Service Type:** [cpr_mission_manager_msgs/srv/ImportData](definitions#storage-importdata)
...
**Service Type:** [cpr_mission_manager_msgs/srv/UpdateMission](definitions#storage-updatemission)
...
**Service Type:** [cpr_mission_manager_msgs/srv/UpdateTask](definitions#storage-updatetask)
...
**Service Type:** [cpr_mission_manager_msgs/srv/UpdateWaypoint](definitions#storage-updatewaypoint)
