...
- [Platform API](api_endpoints/platform_api.mdx): The set of [ROS
  ...
  - [Topics Published by UGV](api_endpoints/platform_api.mdx#topics-published-by-platform):
    The set of topics that are published by the hardware platform.
  - [Topics Subscribed to by UGV](api_endpoints/platform_api.mdx#topics-subscribed-by-platform):
...
- [Autonomy API](api_endpoints/autonomy_api.mdx): The set of [ROS
  ...
  autonomy software.
  - [Topics Published by Autonomy](api_endpoints/autonomy_api.mdx#topics-published-by-autonomy):
    The set of [ROS Topics](http://wiki.ros.org/Topics) published by
    OutdoorNav Software, to be subscribed to by the UGV.
  - [Topics Subscribed to by Autonomy](api_endpoints/autonomy_api.mdx#topics-subscribed-to-by-autonomy):
  ...
  - [Services Exported by Autonomy](api_endpoints/autonomy_api.mdx#services-exported-by-autonomy):
  ...
  - [Actions Exported by Autonomy](api_endpoints/autonomy_api.mdx#actions-exported-by-autonomy):
