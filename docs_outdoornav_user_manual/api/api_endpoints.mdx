...
## Mission API Services {#services-mission-api}

The Mission Manager API allows creation, deletion, and modification of OutdoorNav missions.  Mission data is stored
in a databse-like structure on-disk.  The web-based GUI is the primary method of managing missions, but this service
API provides the ability to write your front-end if desired.
...
#### onav_mission_manager_msgs/msg/Mission #{storage-mission}
...
onav_mission_manager_msgs/Waypoint[] waypoints
...
#### onav_mission_manager_msgs/msg/StorageState #{storage-storagestate}
...
onav_mission_manager_msgs/Mission[] missions

# All waypoints defined in the database
onav_mission_manager_msgs/Waypoint[] waypoints

# All tasks defined in the database
onav_mission_manager_msgs/Task[] tasks

```

#### onav_mission_manager_msgs/msg/Task #{storage-task}
...
#### onav_mission_manager_msgs/msg/Waypoint #{storage-waypoint}
...
#### onav_mission_manager_msgs/srv/AddRemoveById #{storage-addremovebyid}
...
onav_mission_manager_msgs/Mission result
```
...
onav_mission_manager_msgs/Task result
```
...
onav_mission_manager_msgs/Waypoint result
```
...
```
# Required by ROS; the value is ignored
bool req_data
---
...
onav_mission_manager_msgs/Mission mission
```
...
onav_mission_manager_msgs/Task task
```
...
onav_mission_manager_msgs/Waypoint waypoint
```
