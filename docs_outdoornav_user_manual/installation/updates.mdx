...
4. Transfer all files to the robot's **/opt/onav/** folder
    ...
    **Linux**:
    ...
    ```code
    scp cpr-onav-app.zip cpr-onav-ui.tar cpr-onav-autonomy.tar robot@192.168.131.1:/opt/onav/
    ```
...
1. Remove all extraneous files
    ...
    ```code
    rm /opt/onav/cpr-onav-ui.tar /opt/onav/cpr-onav-autonomy.tar /opt/onav/cpr-onav-app.zip
    ```
