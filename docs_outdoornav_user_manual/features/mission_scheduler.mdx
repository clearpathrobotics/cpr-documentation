...
schedule will disable itself and can be re-enabled to run again later.  The view itself can be found in this screen shot and is elaborated further afterwards.
